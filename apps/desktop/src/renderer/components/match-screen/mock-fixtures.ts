// src/renderer/components/match-screen/mock-fixtures.ts
import type { Matchscreen } from "./types.js";

// Scenario 1: Extra-time finish (Reference A style - cup match going to ET)
// Sunderland 5-3 Blackburn, went to extra time
export const scenario1: Matchscreen = {
  matchId: "cup-001",
  homeTeam: {
    id: "sunderland",
    name: "Sunderland",
...
export const scenario2: Matchscreen = {
  matchId: "league-002",
  homeTeam: {
    id: "wolves",
    name: "Wolves",
...
export const scenario3: Matchscreen = {
  matchId: "league-003",
  homeTeam: {
    id: "tottenham",
    name: "Tottenham",
