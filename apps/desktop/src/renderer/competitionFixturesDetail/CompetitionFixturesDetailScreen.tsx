...
export const CompetitionFixturesDetailScreen = ({ saveId: _saveId, competitionId }: { readonly saveId: SaveId; readonly competitionId: CompetitionId }) => (
  <main
    tabIndex={-1}
    data-focus-id="competitionFixturesDetail"
    aria-label="Competition Fixtures Detail"
    className={`bg-background p-8 text-foreground ${FOCUS_RING.join(" ")}`}
  >
    <h1 className="text-2xl font-bold">Competition Fixtures Detail</h1>
