...
export const ClubFinancesDetailScreen = ({ saveId: _saveId, clubId }: { readonly saveId: SaveId; readonly clubId: ClubId }) => (
  <main
    tabIndex={-1}
    data-focus-id="clubFinancesDetail"
    aria-label="Club Finances"
