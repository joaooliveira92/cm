  ...
  useEffect(() => {
    ...
    if (nav && saveId !== undefined) {
      const target: Record<SaveScopedCareerDestinationType, () => void> = {
        ...
        budgetReview: () => navigateCareer({ type: "budgetReview", saveId }, "keyboard"),
        transferHistory: () => navigateCareer({ type: "transferHistory", saveId }, "keyboard"),
        ...
        finances: () => navigateCareer({ type: "finances", saveId }, "keyboard"),
        staffOverview: () => navigateCareer({ type: "staffOverview", saveId }, "keyboard"),
        shortlist: () => navigateCareer({ type: "shortlist", saveId }, "keyboard"),
        scouting: () => navigateCareer({ type: "scouting", saveId }, "keyboard"),
        scoutingAssignment: () => navigateCareer({ type: "scoutingAssignment", saveId }, "keyboard"),
        scoutingKnowledge: () => navigateCareer({ type: "scoutingKnowledge", saveId }, "keyboard"),
