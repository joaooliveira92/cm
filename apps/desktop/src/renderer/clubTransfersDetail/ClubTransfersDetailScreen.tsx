...
export const ClubTransfersDetailScreen = ({ saveId: _saveId, clubId }: { readonly saveId: SaveId; readonly clubId: ClubId }) => (
  <main
    tabIndex={-1}
    data-focus-id="clubTransfersDetail"
    aria-label="Club Transfers"
