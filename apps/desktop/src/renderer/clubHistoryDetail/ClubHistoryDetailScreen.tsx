...
export const ClubHistoryDetailScreen = ({ saveId: _saveId, clubId }: { readonly saveId: SaveId; readonly clubId: ClubId }) => (
  <main
    tabIndex={-1}
    data-focus-id="clubHistoryDetail"
    aria-label="Club History"
    className={`bg-background p-8 text-foreground ${FOCUS_RING.join(" ")}`}
  >
    <h1 className="text-2xl font-bold">Club History</h1>
