...
export const StaffHistoryScreen = ({ saveId: _saveId, staffId }: { readonly saveId: SaveId; readonly staffId: string }) => (
  <main
    tabIndex={-1}
    data-focus-id="staffHistory"
    aria-label="Staff History"
