...
export const CompetitionStagesScreen = ({ saveId: _saveId, competitionId }: { readonly saveId: SaveId; readonly competitionId: CompetitionId }) => (
  <main
    tabIndex={-1}
    data-focus-id="competitionStages"
    aria-label="Competition Stages"
    className={`bg-background p-8 text-foreground ${FOCUS_RING.join(" ")}`}
  >
    <h1 className="text-2xl font-bold">Competition Stages</h1>
