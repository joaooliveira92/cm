 ...
 * career reads its events back through). `careerSetupSummary` is the Review step's read of a
 * provisional world, so it sits here beside `clubSelection` rather than in the world subsystem
 * that generated it.
 */
...
export { getCareerSetupSummary } from "./careerSetupSummary.js";
