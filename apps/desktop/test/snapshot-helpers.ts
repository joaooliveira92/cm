import {
  type InvalidLeagueSelectionError,
  NationId,
 ...
 */
export const createDefaultSnapshot = (userDataDir: string): Effect.Effect<SnapshotId, InvalidLeagueSelectionError> =>
 ...
 * a real selection.
 */
export const createWiderSnapshot = (userDataDir: string): Effect.Effect<SnapshotId, InvalidLeagueSelectionError> =>
...
export const createPyramidSnapshot = (userDataDir: string): Effect.Effect<SnapshotId, InvalidLeagueSelectionError> =>
  createSnapshotFor(userDataDir, [
    new NationSelectionIntentPayload({
...
export const createRegionalPlusEnglandSnapshot = (userDataDir: string): Effect.Effect<SnapshotId, InvalidLeagueSelectionError> =>
  createSnapshotFor(userDataDir, [
    ...DEFAULT_CAREER_INTENTS,
    new NationSelectionIntentPayload({
      nationId: NationId.make("nation_esp"),
