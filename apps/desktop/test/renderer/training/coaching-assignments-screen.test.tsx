...
import { CoachingAssignmentsScreen } from "../../../src/renderer/training/CoachingAssignmentsScreen.js";
...
const renderScreen = () =>
  render(
    <RegistryProvider>
      <CoachingAssignmentsScreen saveId={rid("s1")} />
    </RegistryProvider>,
  );
...
describe("ticket 05 — Workload and Recovery is reachable from the Coaching Assignments screen", () => {
...
describe("ticket 08 — the Player Development Centre is reachable from the Coaching Assignments screen", () => {
