# Screen 160: Board Meeting and Performance Review
...
Board Meeting and Performance Review provides a structured review of objectives, results, finances, transfers, squad development, club culture, active requests, and agreed follow-up actions.

## 2. Primary user goals

- Review the agenda and evidence pack
- Respond to policy-defined questions
- Discuss objectives and active requests
- Accept measurable follow-up actions
- Confirm one board-meeting outcome transaction
...
```text
+------------------------------------------------------------------------------+
| Agenda, attendees, objectives, evidence, confidence, questions, decisions, a |
|------------------------------------------------------------------------------|
...
- Meeting dialogue remains professional and nonabusive
- Outcomes reference current evidence revisions
- Promises and follow-up actions require dates and measurable terms
- The meeting cannot silently dismiss or renew the manager outside explicit workflows
...
1. Meeting dialogue remains professional and nonabusive
2. Outcomes reference current evidence revisions
3. Promises and follow-up actions require dates and measurable terms
4. The meeting cannot silently dismiss or renew the manager outside explicit workflows
...
```text
Implement Board Meeting and Performance Review for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify board meeting and performance review screen
```
