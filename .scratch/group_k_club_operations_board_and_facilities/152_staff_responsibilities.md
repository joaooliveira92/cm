# Screen 152: Staff Responsibilities
...
Staff Responsibilities assigns operational duties such as training, transfers, contracts, scouting, media, team talks, youth development, and match preparation to eligible staff.

## 2. Primary user goals

- Assign or remove a primary responsibility owner
- Configure permitted approval thresholds
- Set backup responsibility holders
- Review workload and authority conflicts
- Save one validated delegation revision
...
```text
+------------------------------------------------------------------------------+
| Responsibilities, owners, backups, authority, workload, conflicts, effective |
|------------------------------------------------------------------------------|
...
```typescript
interface StaffResponsibilityDraft {
...
- Responsibility assignment does not change employment role
- Delegated staff cannot exceed manager or board authority
- Critical responsibilities require a valid owner
- Remote changes use revisions and conflict handling
...
1. Responsibility assignment does not change employment role
2. Delegated staff cannot exceed manager or board authority
3. Critical responsibilities require a valid owner
4. Remote changes use revisions and conflict handling
...
```text
Implement Staff Responsibilities for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff responsibilities screen
```
