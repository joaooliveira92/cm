...
Board Objectives presents current league, cup, financial, development, recruitment, style, culture, and facility expectations with progress, importance, review dates, and consequences.

## 2. Primary user goals

- Filter objectives by category and importance
- Open evidence supporting progress
- Review fulfilled, on-course, at-risk, failed, and superseded objectives
- Navigate to related competition, finance, squad, or development screens
...
```text
+------------------------------------------------------------------------------+
| Objectives, priorities, progress, evidence, deadlines, review dates, consequ |
|------------------------------------------------------------------------------|
...
```typescript
interface BoardObjectivesModel {
...
- Objectives are versioned career commitments
- Progress reasons must reference committed facts
- Hidden dismissal formulas are not exposed
- Superseded objectives remain in history
...
1. Objectives are versioned career commitments
2. Progress reasons must reference committed facts
3. Hidden dismissal formulas are not exposed
4. Superseded objectives remain in history
...
```text
Implement Board Objectives for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify board objectives screen
```
