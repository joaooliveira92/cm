...
The Board Overview consolidates club leadership, ownership, confidence, objectives, financial constraints, active requests, strategic projects, and upcoming review dates.

## 2. Primary user goals

- Review board members and ownership structure
- Open objectives, requests, vision, finances, and projects
- Inspect current confidence reasons and trends
- Review upcoming board meetings and decision deadlines
...
```text
+------------------------------------------------------------------------------+
| Leadership, confidence, objectives, requests, finances, projects, review dat |
|------------------------------------------------------------------------------|
...
- Board confidence and supporter sentiment remain separate
- Private board information requires club authority
- Overview values use one coherent board revision
- The screen is read-only except for explicit linked workflows
...
1. Board confidence and supporter sentiment remain separate
2. Private board information requires club authority
3. Overview values use one coherent board revision
4. The screen is read-only except for explicit linked workflows
...
```text
Implement Board Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify board overview screen
```
