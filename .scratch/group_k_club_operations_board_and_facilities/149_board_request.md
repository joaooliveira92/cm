...
Board Request lets an authorized manager request budgets, facilities, staffing changes, affiliates, contract exceptions, scouting coverage, or other policy-supported club resources.

## 2. Primary user goals

- Choose a supported request type
- Provide structured rationale and supporting evidence
- Review cost, timing, prerequisites, and conflicts
- Submit, save, revise, or withdraw the request
...
```text
+------------------------------------------------------------------------------+
| Request type, rationale, evidence, cost, timing, prerequisites, likely conce |
|------------------------------------------------------------------------------|
...
- Requests use policy-defined types rather than unrestricted commands
- Free text is optional, bounded, and untrusted
- Submission does not guarantee approval
- Costs and budget effects are authoritative
...
1. Requests use policy-defined types rather than unrestricted commands
2. Free text is optional, bounded, and untrusted
3. Submission does not guarantee approval
4. Costs and budget effects are authoritative
...
```text
Implement Board Request for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify board request screen
```
