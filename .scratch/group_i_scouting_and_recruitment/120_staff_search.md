...
Staff Search finds managers, coaches, scouts, analysts, medical staff, directors, and support personnel using role, qualification, reputation, attributes, languages, contract, availability, wage estimate, and knowledge criteria.

## 2. Primary user goals

- Search by supported staff role and capability
- Save and restore manager-private searches
- Open staff profiles, contracts, reports, and history
- Add to staff shortlist
- Open an authorized approach or scouting workflow
...
```text
+------------------------------------------------------------------------------+
| Staff criteria, role and qualification filters, results, knowledge, shortlis |
|------------------------------------------------------------------------------|
...
- Role eligibility and capability are distinct
- Wage and interest information may be estimated
- Private contract terms remain restricted
- Search cannot bypass staff-hiring authority or vacancy limits
...
1. Role eligibility and capability are distinct
2. Wage and interest information may be estimated
3. Private contract terms remain restricted
4. Search cannot bypass staff-hiring authority or vacancy limits
...
```text
Implement Staff Search for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff search screen
```
