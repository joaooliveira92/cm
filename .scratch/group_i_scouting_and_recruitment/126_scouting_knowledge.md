...
Scouting Knowledge visualizes the club and manager’s knowledge coverage across nations, regions, competitions, clubs, players, staff, and tactical domains.

## 2. Primary user goals

- Switch between geographic, competition, club, person, and tactical knowledge views
- Open contributing scouts and reports
- Identify gaps and create assignments
- Review coverage changes over time
- Compare club and manager knowledge scopes
...
```text
+------------------------------------------------------------------------------+
| Geographic and competition coverage, confidence, freshness, contributing sta |
|------------------------------------------------------------------------------|
...
```typescript
interface ScoutingKnowledgeModel {
...
- Knowledge is scoped, time-sensitive, and decays according to policy
- A map must have an accessible list equivalent
- Coverage does not imply exact knowledge of every person
- Manager and club knowledge inheritance must be explicit
...
1. Knowledge is scoped, time-sensitive, and decays according to policy
2. A map must have an accessible list equivalent
3. Coverage does not imply exact knowledge of every person
4. Manager and club knowledge inheritance must be explicit
...
```text
Implement Scouting Knowledge for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify scouting knowledge screen
```
