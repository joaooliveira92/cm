...
Staff Shortlist stores prospective coaches, scouts, analysts, medical staff, directors, and managers with role fit, qualifications, contract state, wage estimates, notes, and approach status.

## 2. Primary user goals

- Add, remove, rank, tag, and group staff candidates
- Open profile, contract, history, comparison, or approach workflow
- Assign additional scouting
- Record manager-private notes and reminders
- Archive hired, rejected, or unavailable candidates
...
```text
+------------------------------------------------------------------------------+
| Shortlisted staff, desired role, fit, knowledge, contract, estimated wage, n |
|------------------------------------------------------------------------------|
...
- A shortlist is not a job offer
- Role fit is advisory and knowledge-limited
- Private notes and approach terms require permission
- Hired staff remain in history without remaining active targets by default
...
1. A shortlist is not a job offer
2. Role fit is advisory and knowledge-limited
3. Private notes and approach terms require permission
4. Hired staff remain in history without remaining active targets by default
...
```text
Implement Staff Shortlist for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff shortlist screen
```
