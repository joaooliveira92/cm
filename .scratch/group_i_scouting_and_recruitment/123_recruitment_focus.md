...
Recruitment Focus defines a reusable candidate-discovery brief, such as a position, tactical role, age band, geography, budget, contract state, or development profile, and routes it to the recruitment team.

## 2. Primary user goals

- Create or edit a recruitment focus
- Select criteria and exclusions
- Assign eligible recruitment staff
- Set review date and reporting cadence
- Pause, complete, duplicate, or archive the focus
...
```text
+------------------------------------------------------------------------------+
| Focus criteria, assigned staff, geographic scope, duration, candidate count, |
|------------------------------------------------------------------------------|
...
```typescript
interface RecruitmentFocusDraft {
...
- Focus criteria must use named policy values
- Candidate generation respects real scouting knowledge and access
- A focus never creates players or hidden knowledge
- Duplicate focuses are allowed only with an explicit warning
...
1. Focus criteria must use named policy values
2. Candidate generation respects real scouting knowledge and access
3. A focus never creates players or hidden knowledge
4. Duplicate focuses are allowed only with an explicit warning
...
```text
Implement Recruitment Focus for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify recruitment focus screen
```
