...
Squad Planner models current and future squad depth by position, role, age, contract horizon, registration status, development pathway, and planned arrivals or departures.

## 2. Primary user goals

- Switch current and future planning periods
- Place players into role and depth slots
- Mark planned sale, loan, promotion, arrival, or retention scenarios
- Create scouting priorities from gaps
- Save manager-private or club-shared planning scenarios
...
```text
+------------------------------------------------------------------------------+
| Current depth, future seasons, role coverage, contracts, departures, arrival |
|------------------------------------------------------------------------------|
...
- Planning scenarios are not canonical transfers or promises
- A player may appear in several alternative scenarios but once per scenario slot policy
- Unconfirmed arrivals and departures remain clearly provisional
- Future age and contract projections use canonical dates
...
1. Planning scenarios are not canonical transfers or promises
2. A player may appear in several alternative scenarios but once per scenario slot policy
3. Unconfirmed arrivals and departures remain clearly provisional
4. Future age and contract projections use canonical dates
...
```text
Implement Squad Planner for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify squad planner screen
```
