# Screen 92: Match Day Team Sheet
...
The Match Day Team Sheet presents both submitted squads immediately before kickoff, including starters, substitutes, formations, captains, shirt numbers, unavailable players, and competition compliance.

## 2. Primary user goals

- Review the submitted home and away teams
- Open visible player profiles
- Return to selection when the controlled team is still editable
- Confirm readiness and enter the live match
...
```text
+------------------------------------------------------------------------------+
| Home and away team sheets, starters, bench, formations, captains, shirt numb |
|------------------------------------------------------------------------------|
...
```typescript
interface MatchDayTeamSheetModel {
...
- Opponent data appears only after the competition release boundary
- Submitted and draft selections remain distinct
- Late changes require explicit competition support
- Team sheets use the authoritative match submission revision
...
1. Opponent data appears only after the competition release boundary
2. Submitted and draft selections remain distinct
3. Late changes require explicit competition support
4. Team sheets use the authoritative match submission revision
...
```text
Implement Match Day Team Sheet for an original football-management simulation. Use one
...
```text
docs(game-ui): specify match day team sheet screen
```
