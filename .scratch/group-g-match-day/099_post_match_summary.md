...
The Post-Match Summary provides the immediate final result, competition consequences, key events, player of the match, injuries, cards, records, table movement, and links to deeper review.

## 2. Primary user goals

- Open statistics, ratings, report, incidents, competition, and player profiles
- Review table or knockout progression changes
- Address immediate post-match actions
- Continue to the post-match team talk or inbox
...
```text
+------------------------------------------------------------------------------+
| Final score, outcome, key events, competition impact, player of match, recor |
|------------------------------------------------------------------------------|
...
```typescript
interface PostMatchSummaryModel {
...
- The summary appears only after final match commit
- Awarded, abandoned, extra-time, and penalty outcomes are explicit
- Competition consequences use the updated authoritative table
- Records are confirmed before display
...
1. The summary appears only after final match commit
2. Awarded, abandoned, extra-time, and penalty outcomes are explicit
3. Competition consequences use the updated authoritative table
4. Records are confirmed before display
...
```text
Implement Post-Match Summary for an original football-management simulation. Use one
...
```text
docs(game-ui): specify post match summary screen
```
