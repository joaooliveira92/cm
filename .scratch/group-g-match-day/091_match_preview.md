...
The Match Preview consolidates fixture context, competition rules, venue, officials, weather where modeled, team news, odds or expectations where permitted, previous meetings, opposition intelligence, tactical readiness, and submission deadlines before kickoff.

## 2. Primary user goals

- Open team selection, tactics, opposition report, competition rules, and venue
- Review expected lineups and unavailable players
- Submit or revise the match squad before the deadline
- Proceed to the match when all mandatory requirements are valid
...
```text
+------------------------------------------------------------------------------+
| Fixture context, previous meetings, team news, weather, officials, tactical  |
|------------------------------------------------------------------------------|
...
- Preview information must not reveal hidden opposition choices
- Odds and expectations are contextual estimates, not guarantees
- The kickoff and submission deadline are authoritative
- Weather and official data are optional only when the simulation models them
...
1. Preview information must not reveal hidden opposition choices
2. Odds and expectations are contextual estimates, not guarantees
3. The kickoff and submission deadline are authoritative
4. Weather and official data are optional only when the simulation models them
...
```text
Implement Match Preview for an original football-management simulation. Use one
...
```text
docs(game-ui): specify match preview screen
```
