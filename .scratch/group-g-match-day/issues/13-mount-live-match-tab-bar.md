...
- [x] The match tab bar renders on Match day and the match sub-screens
- [x] Each live-match tab navigates to its screen, including Tactics and Substitutions
- [x] Each post-match tab (Summary, Statistics, Player Ratings, Report) navigates to its screen —
      ticket 08's criterion "accessible via the post-match tab navigation" lands here
- [x] Decide whether the ticket 07 and 08 buttons stay once the tab bar exists
