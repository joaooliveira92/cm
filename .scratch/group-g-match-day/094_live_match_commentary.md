# Screen 94: Live Match Commentary
...
Live Match Commentary displays a chronological, localized, accessible stream of match events, tactical observations, incidents, substitutions, goals, cards, injuries, and stoppages.

## 2. Primary user goals

- Follow events automatically or pause auto-scroll
- Filter all, key, team, disciplinary, and substitution events
- Open linked player or incident details
- Change commentary presentation pace without changing match processing
...
```text
+------------------------------------------------------------------------------+
| Chronological commentary, event filters, important-event navigation, caption |
|------------------------------------------------------------------------------|
...
```typescript
interface LiveMatchCommentaryModel {
...
- Commentary is generated from committed event facts
- Text must not contain harmful or demeaning generated content
- Repeated event templates require variation without factual drift
- Auto-scroll must stop when the user reviews earlier events
...
1. Commentary is generated from committed event facts
2. Text must not contain harmful or demeaning generated content
3. Repeated event templates require variation without factual drift
4. Auto-scroll must stop when the user reviews earlier events
...
```text
Implement Live Match Commentary for an original football-management simulation. Use one
...
```text
docs(game-ui): specify live match commentary screen
```
