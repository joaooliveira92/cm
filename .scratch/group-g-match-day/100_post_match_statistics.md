# Screen 100: Post-Match Statistics
...
Post-Match Statistics presents finalized team and period metrics with event-backed definitions, comparisons, visual summaries, and export-safe data.

## 2. Primary user goals

- Switch periods and metric categories
- Open event-backed subsets
- Compare home and away performance
- Export a safe statistical summary
...
```text
+------------------------------------------------------------------------------+
| Final team metrics, period breakdown, shot and event maps where supported, m |
|------------------------------------------------------------------------------|
...
```typescript
interface PostMatchStatisticsModel {
...
- Statistics are immutable after match commit except audited correction
- Every visualization has a textual equivalent
- Coordinates and maps must not imply unsupported precision
- All totals reconcile with the canonical event stream
...
1. Statistics are immutable after match commit except audited correction
2. Every visualization has a textual equivalent
3. Coordinates and maps must not imply unsupported precision
4. All totals reconcile with the canonical event stream
...
```text
Implement Post-Match Statistics for an original football-management simulation. Use one
...
```text
docs(game-ui): specify post match statistics screen
```
