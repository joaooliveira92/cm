# Screen 34: Club General Information
...
Club General Information presents stable identity, ownership, location, competition membership, rivals, supporter profile, media description, reputation, colours, and organizational structure without duplicating facilities or historical screens.

## 2. Primary user goals

- Open nation, locality, competition, rival, owner, or affiliate
- Switch between concise and expanded descriptions
- Copy a safe public club summary
- Inspect unavailable historical references through fallback labels
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > GENERAL INFORMATION                                           |
|------------------------------------------------------------------------------|
| Founded 1908 | City: Northport | Nation: Exampleland                         |
| Status: Professional | Reputation: National                                  |
| Competition: First Division                                                  |
|------------------------------------------------------------------------------|
| Ownership and leadership | Supporters | Rivals | Affiliations                 |
| [Open Competition] [Open City] [Open Affiliate]                       [Back] |
+------------------------------------------------------------------------------+
```
...
```typescript
interface ClubGeneralInformationModel {
  readonly clubId: string;
  readonly displayName: string;
  readonly foundedYear?: number;
  readonly location: ClubLocationSummary;
  readonly professionalStatusId: string;
  readonly reputationBandId: string;
  readonly competitionMemberships: readonly ClubCompetitionMembership[];
  readonly ownership: ClubOwnershipSummary;
  readonly rivals: readonly ClubRelationshipSummary[];
  readonly affiliations: readonly ClubAffiliationSummary[];
...
- Names, colours, badges, nicknames, and descriptions require original or licensed assets
- Reputation is a simulation value, not a moral judgment
- Historic and current competition membership must be distinct
- Ownership details must respect database confidence and season date
...
1. Names, colours, badges, nicknames, and descriptions require original or licensed assets
2. Reputation is a simulation value, not a moral judgment
3. Historic and current competition membership must be distinct
4. Ownership details must respect database confidence and season date
...
```text
Implement Club General Information for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club general information screen
```
