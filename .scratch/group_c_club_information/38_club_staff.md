...
Club Staff lists managerial, coaching, recruitment, medical, executive, and support personnel, their roles, contracts, workload, vacancies, and permitted staffing actions.

## 2. Primary user goals

- Filter by department and role
- Open staff profile, contract, history, or responsibilities
- Assign responsibilities and coaching categories
- Renew, terminate, or offer contracts through dedicated workflows
- Open staff search and vacancy views
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > STAFF                               24 staff                   |
|------------------------------------------------------------------------------|
| [All] [Coaching] [Recruitment] [Medical] [Executive] [Vacancies]              |
| Name               Role                 Contract  Workload   Status            |
| Jamie Assistant    Assistant Manager    2007      Medium     Active            |
|------------------------------------------------------------------------------|
| [Open Profile] [Responsibilities] [Offer Contract] [Search Staff]      [Back]|
+------------------------------------------------------------------------------+
```
...
```typescript
interface ClubStaffRow {
  readonly staffId: string;
  readonly roleAssignmentIds: readonly string[];
  readonly contractSummary: StaffContractSummary;
  readonly workload: StaffWorkloadSummary;
  readonly availability: StaffAvailabilitySummary;
  readonly knowledgeSummary?: StaffKnowledgeSummary;
  readonly permittedActions: readonly StaffAction[];
}
```
...
- Employment role, coaching assignment, and responsibility delegation are distinct
- Private staff attributes obey viewer knowledge
- Contract actions require budget and authority validation
- Vacancies must not be represented by fake staff records
...
1. Employment role, coaching assignment, and responsibility delegation are distinct
2. Private staff attributes obey viewer knowledge
3. Contract actions require budget and authority validation
4. Vacancies must not be represented by fake staff records
...
```text
Implement Club Staff for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club staff screen
```
