# Screen 47: Supporter and Board Confidence
...
Supporter and Board Confidence presents separate confidence dimensions for results, competitions, finances, transfers, squad management, player development, club culture, and supporter sentiment.

## 2. Primary user goals

- Open objective details
- Inspect confidence changes over time
- Open linked results, transfers, or board messages
- Switch between board and supporter perspectives
- Review only information visible to the active manager
...
Global Application Shell
  -> Club
  -> Supporter and Board Confidence
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > CONFIDENCE                                                    |
|------------------------------------------------------------------------------|
| Overall board confidence: Stable                                              |
| Supporter sentiment: Positive                                                 |
|------------------------------------------------------------------------------|
| Match results            Satisfied       Trend: Improving                     |
| League objective         On course                                           |
| Transfers                Concerned       Recent signing questioned            |
| Finances                 Satisfied                                           |
| Player development       Very satisfied                                      |
|------------------------------------------------------------------------------|
| [Board Objectives] [Confidence History] [Relevant Message]             [Back] |
+------------------------------------------------------------------------------+
```
...
```typescript
interface ClubConfidenceModel {
  readonly clubId: string;
  readonly managerId: string;
  readonly asOfDate: string;
  readonly overallBoardBand: string;
  readonly supporterBand: string;
  readonly dimensions: readonly ConfidenceDimensionSummary[];
  readonly objectives: readonly BoardObjectiveProgress[];
  readonly trendHistory: readonly ConfidenceTrendPoint[];
  readonly visibility: ConfidenceVisibilityPolicy;
}
```
...
- Board and supporter confidence are distinct
- Qualitative bands should not expose hidden dismissal formulas
- Reasons must link to committed career facts
- Confidence cannot be edited from this screen
...
1. Board and supporter confidence are distinct
2. Qualitative bands should not expose hidden dismissal formulas
3. Reasons must link to committed career facts
4. Confidence cannot be edited from this screen
...
```text
Implement Supporter and Board Confidence for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify supporter and board confidence screen
```
