...
Club Fixtures lists scheduled matches, postponements, draws, venues, competitions, broadcast or travel context, and preparation status for the selected club.

## 2. Primary user goals

- Filter by competition, month, venue, and status
- Open match preview or completed result
- Navigate to opponent, competition, venue, or calendar date
- Review postponement or rescheduling explanation
- Export a privacy-safe fixture list
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > FIXTURES                              Season 2004/05           |
|------------------------------------------------------------------------------|
| [Month v] [Competition: All v] [Home/Away: All v]                             |
| 15 Feb  Example City       H  League       19:45  Scheduled                   |
| 19 Feb  Coastal Athletic   A  Cup          15:00  Scheduled                   |
| 22 Feb  South Town         A  League       19:45  Provisional                 |
|------------------------------------------------------------------------------|
| [Calendar] [Match Preview] [Export View]                               [Back] |
+------------------------------------------------------------------------------+
```
...
interface ClubFixtureRow {
  ...
  readonly status: "scheduled" | "provisional" | "postponed" | "cancelled" | "completed";
  readonly preparationState?: FixturePreparationSummary;
...
- Fixture time and status must come from one authoritative revision
- Provisional and confirmed dates are distinct
- Timezone display must not alter canonical kickoff time
- Preparation links obey manager permissions
...
1. Fixture time and status must come from one authoritative revision
2. Provisional and confirmed dates are distinct
3. Timezone display must not alter canonical kickoff time
4. Preparation links obey manager permissions
...
```text
Implement Club Fixtures for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club fixtures screen
```
