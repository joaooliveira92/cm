...
Club History presents the club’s chronological identity, competition membership, promotions, relegations, ownership changes, stadium moves, notable seasons, and historical narrative.

## 2. Primary user goals

- Switch timeline, seasons, managers, and league-history views
- Open historical season, competition, stadium, or manager
- Filter event type and period
- Export a safe public history summary
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > HISTORY                                                       |
|------------------------------------------------------------------------------|
| [Timeline] [Season by Season] [Managers] [League History]                     |
| 2004/05  First Division, current season                                       |
| 2003/04  Promoted as Second Division champions                                |
| 1998     Moved to Northport Stadium                                           |
|------------------------------------------------------------------------------|
| [Open Season] [Open Former Manager]                                    [Back] |
+------------------------------------------------------------------------------+
```
...
- History is append-only canonical data
- Unknown dates and uncertain records must remain explicitly uncertain
- Renamed or extinct linked entities need historical fallback labels
- Narrative text must be original and generated from safe structured facts
...
1. History is append-only canonical data
2. Unknown dates and uncertain records must remain explicitly uncertain
3. Renamed or extinct linked entities need historical fallback labels
4. Narrative text must be original and generated from safe structured facts
...
```text
Implement Club History for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club history screen
```
