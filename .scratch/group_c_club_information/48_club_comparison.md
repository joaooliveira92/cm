...
Club Comparison compares two or more clubs across competition level, reputation, finances, squad profile, facilities, supporters, recent performance, and honours using normalized, permission-aware measures.

## 2. Primary user goals

- Choose comparison clubs
- Select metric categories
- Swap primary and comparison clubs
- Open a club or metric explanation
- Save a personal comparison preset where supported
...
| CLUB COMPARISON                                                              |
|------------------------------------------------------------------------------|
| Compare [North United v] with [Example City v]                                |
| Category                 North United          Example City                   |
| Reputation               National              National                       |
| Stadium capacity          38,500                42,100                         |
| Training facilities       Good                  Excellent                      |
| Average squad age         25.6                  27.1                           |
| Recent form               W D W L W             D W L D W                     |
|------------------------------------------------------------------------------|
| [Change Categories] [Swap Clubs] [Open Club]                           [Back] |
+------------------------------------------------------------------------------+
```
...
```typescript
interface ClubComparisonModel {
  readonly clubIds: readonly string[];
  readonly categoryIds: readonly string[];
  readonly columns: readonly ClubComparisonColumn[];
  readonly rows: readonly ClubComparisonMetricRow[];
  readonly asOfRevision: number;
  readonly visibilityWarnings: readonly string[];
}
```
...
- Metrics need normalized definitions and units
- Unavailable private values must show Unknown rather than infer a result
- Comparisons use one coherent career revision
- Qualitative bands require accessible text and metric explanations
...
1. Metrics need normalized definitions and units
2. Unavailable private values must show Unknown rather than infer a result
3. Comparisons use one coherent career revision
4. Qualitative bands require accessible text and metric explanations
...
```text
Implement Club Comparison for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club comparison screen
```
