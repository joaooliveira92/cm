# Screen 46: Club Information and Facilities
...
Club Information and Facilities describes the stadium, training ground, youth development, recruitment reach, medical infrastructure, ownership of facilities, expansions, relocations, and planned improvements.

## 2. Primary user goals

- Open stadium and facility details
- Review completed and planned projects
- Open board-request workflow when authorized
- Compare facilities with another club
- Inspect temporary venue arrangements
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > INFORMATION AND FACILITIES                                    |
|------------------------------------------------------------------------------|
| Stadium: Northport Stadium       Capacity: 38,500                             |
| Ownership: Club owned            Surface: Grass                               |
|------------------------------------------------------------------------------|
| Training facilities: Good          Youth facilities: Adequate                 |
| Recruitment reach: National        Medical facilities: Good                   |
|------------------------------------------------------------------------------|
| Planned work: Training upgrade, completion July 2005                          |
| [Open Stadium] [Facility History] [Board Request]                      [Back] |
+------------------------------------------------------------------------------+
```
...
```typescript
interface ClubFacilitiesModel {
  readonly clubId: string;
  readonly stadium: StadiumSummary;
  readonly trainingProfileId: string;
  readonly youthProfileId: string;
  readonly recruitmentProfileId: string;
  readonly medicalProfileId: string;
  readonly ownershipSummary: FacilityOwnershipSummary;
  readonly plannedProjects: readonly FacilityProjectSummary[];
...
- Facility profiles are policy-defined qualitative bands
- Capacity, ownership, and venue availability must be distinct
- Planned completion dates are estimates until committed events
- Board actions require finance and authority validation
...
1. Facility profiles are policy-defined qualitative bands
2. Capacity, ownership, and venue availability must be distinct
3. Planned completion dates are estimates until committed events
4. Board actions require finance and authority validation
...
```text
Implement Club Information and Facilities for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club information and facilities screen
```
