# Screen 217: International Competition Campaign
...
Tracks a national team’s qualifying or tournament campaign through fixtures, table or bracket position, objectives, permutations, squad windows, and milestones.

## 2. Primary user goals

- Review current stage and qualification position
- Open fixtures, results, standings, rules, and squad windows
- Inspect authoritative qualification paths
- Review federation objectives and campaign history
...
Global Application Shell
  -> National Team
  -> International Competition Campaign
...
- Qualification permutations are calculated by trusted services
- Conditional outcomes are clearly provisional
- Campaign and friendly records remain separate
- Current and historical editions use distinct rules
...
1. Qualification permutations are calculated by trusted services
2. Conditional outcomes are clearly provisional
3. Campaign and friendly records remain separate
4. Current and historical editions use distinct rules
...
```text
Implement International Competition Campaign for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international competition campaign screen
```
