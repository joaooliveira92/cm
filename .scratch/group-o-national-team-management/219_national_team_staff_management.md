# Screen 219: National Team Staff Management
...
Manages national-team coaches, scouts, analysts, medical staff, and delegated responsibilities across senior and youth selections.

## 2. Primary user goals

- Review current staff and vacancies
- Assign responsibilities
- Offer or end supported federation contracts
- Allocate scouting and coaching work
...
Global Application Shell
  -> National Team
  -> National Team Staff Management
...
- Federation contracts remain separate from club employment
- A staff member may hold dual roles only when policy permits
- Delegation cannot exceed manager authority
- Private capabilities remain knowledge-limited
...
1. Federation contracts remain separate from club employment
2. A staff member may hold dual roles only when policy permits
3. Delegation cannot exceed manager authority
4. Private capabilities remain knowledge-limited
...
```text
Implement National Team Staff Management for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify national team staff management screen
```
