# Screen 210: International Player Eligibility
...
Explains whether a player may represent a selected national team, including nationality links, prior appearances, age-level history, waiting periods, registration, and competition restrictions.

## 2. Primary user goals

- Open the player and relevant national teams
- Review each supporting eligibility rule
- Inspect unresolved or provisional evidence
- Return to selection with context preserved
...
- Eligibility is calculated only by the trusted rules service
- The screen provides simulation rules, not legal advice
- Sensitive identity evidence is not exposed unnecessarily
- Unknown evidence remains unresolved rather than guessed
...
1. Eligibility is calculated only by the trusted rules service
2. The screen provides simulation rules, not legal advice
3. Sensitive identity evidence is not exposed unnecessarily
4. Unknown evidence remains unresolved rather than guessed
...
```text
Implement International Player Eligibility for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international player eligibility screen
```
