# Screen 221: International Management History
...
Provides a durable chronology of national-team appointments, squads, fixtures, competitions, rankings, honours, milestones, selections, and federation decisions.

## 2. Primary user goals

- Browse appointments, campaigns, squads, results, and milestones
- Open historical team, competition, fixture, or person
- Filter by team level and period
...
Global Application Shell
  -> National Team
  -> International Management History
...
- Historical eligibility and rules remain edition-bound
- Unavailable entities retain safe labels
- Private failed approaches are excluded from public exports
...
2. Historical eligibility and rules remain edition-bound
3. Unavailable entities retain safe labels
4. Private failed approaches are excluded from public exports
...
```text
Implement International Management History for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international management history screen
```
