# Screen 216: Tournament Squad Registration
...
Registers the final tournament squad and replacements under competition-specific limits, deadlines, shirt-number rules, medical replacement rules, and eligibility requirements.

## 2. Primary user goals

- Select and validate tournament players
- Assign required numbers
- Inspect replacement and late-change rules
- Submit or revise before the deadline
...
- Registered, called up, eligible, and available remain distinct
- Replacement rules use competition policy
- Submission is atomic
- Renderer state cannot grant eligibility
...
1. Registered, called up, eligible, and available remain distinct
2. Replacement rules use competition policy
3. Submission is atomic
4. Renderer state cannot grant eligibility
...
```text
Implement Tournament Squad Registration for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify tournament squad registration screen
```
