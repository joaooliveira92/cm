# Screen 214: International Training and Camp
...
Plans international camps and limited training sessions around reporting, travel, recovery, media, and match dates.

## 2. Primary user goals

- Schedule permitted preparation and recovery sessions
- Assign temporary training units
- Review travel, fatigue, and medical restrictions
- Submit the camp plan
...
Global Application Shell
  -> National Team
  -> International Training and Camp
...
- International calendars constrain available training time
- Club workload history informs but does not expose private club tactics
- Medical restrictions override ordinary intensity
- Training effects are probabilistic
...
1. International calendars constrain available training time
2. Club workload history informs but does not expose private club tactics
3. Medical restrictions override ordinary intensity
4. Training effects are probabilistic
...
```text
Implement International Training and Camp for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international training and camp screen
```
