# Screen 161: Competition Overview
...
The Competition Overview is the primary landing page for a league, cup, tournament, or qualifying competition. It combines current stage, holders, participating clubs, table or bracket status, leading performers, upcoming fixtures, recent results, and rule alerts.

## 2. Primary user goals

- Open table, fixtures, results, statistics, rules, stages, draw, awards, history, and records
- Open a participating club or leading player
- Change season or edition
- Review current qualification and stage status
...
```text
+------------------------------------------------------------------------------+
| Stage, holders, participants, leaders, fixtures, results, qualification and  |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionOverviewModel {
...
- The overview uses one competition edition and revision
- Stage-specific content replaces unsupported generic sections
- Holders and current leaders remain distinct
- Results-only simulation must not fabricate detailed leaders
...
1. The overview uses one competition edition and revision
2. Stage-specific content replaces unsupported generic sections
3. Holders and current leaders remain distinct
4. Results-only simulation must not fabricate detailed leaders
...
```text
Implement Competition Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition overview screen
```
