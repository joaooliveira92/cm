# Screen 165: Competition Statistics
...
Competition Statistics summarizes competition-wide performance metrics, trends, totals, averages, distributions, attendance, goals, discipline, and stage comparisons.

## 2. Primary user goals

- Change season, stage, period, and metric category
- Inspect a metric definition and coverage
- Open supporting player, club, or match lists
- Export a permitted statistical summary
...
```text
+------------------------------------------------------------------------------+
| Goals, attendance, discipline, averages, trends, stages, coverage and defini |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionStatisticsModel {
...
- Every metric has a definition and denominator
- Coverage limitations are visible
- Rounding cannot create contradictory totals
- Charts require textual table equivalents
...
1. Every metric has a definition and denominator
2. Coverage limitations are visible
3. Rounding cannot create contradictory totals
4. Charts require textual table equivalents
...
```text
Implement Competition Statistics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition statistics screen
```
