# Screen 164: Competition Results
...
Competition Results presents completed, awarded, abandoned, extra-time, and shootout outcomes grouped by date, round, or stage.

## 2. Primary user goals

- Filter by stage, round, date, or club
- Open match report, statistics, incidents, or participants
- Review bracket or table consequences
- Switch between compact and detailed result views
...
```text
+------------------------------------------------------------------------------+
| Scores, outcomes, rounds, venues, attendance, report detail and progression  |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionResultsModel {
...
- Shootout and extra-time scores remain structurally distinct
- Awarded and abandoned outcomes are labeled explicitly
- Detail availability follows simulation level
- Progression updates only after authoritative result commit
...
1. Shootout and extra-time scores remain structurally distinct
2. Awarded and abandoned outcomes are labeled explicitly
3. Detail availability follows simulation level
4. Progression updates only after authoritative result commit
...
```text
Implement Competition Results for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition results screen
```
