# Screen 176: National Team Overview
...
National Team Overview presents a national side’s current manager, ranking, fixtures, recent form, squad status, qualification campaign, honours, records, and actionable alerts.

## 2. Primary user goals

- Open squad, fixtures, competition, ranking, history, and records
- Review qualification status and upcoming selection deadline
- Open eligible-player search when authorized
- Switch senior and supported youth teams
...
```text
+------------------------------------------------------------------------------+
| Manager, ranking, form, squad, fixtures, qualification, honours and alerts   |
|------------------------------------------------------------------------------|
...
```typescript
interface NationalTeamOverviewModel {
...
- National-team and club employment contexts remain distinct
- Rankings use the correct authoritative snapshot
- Eligibility and selection remain separate
- Private tactical information follows manager permissions
...
1. National-team and club employment contexts remain distinct
2. Rankings use the correct authoritative snapshot
3. Eligibility and selection remain separate
4. Private tactical information follows manager permissions
...
```text
Implement National Team Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify national team overview screen
```
