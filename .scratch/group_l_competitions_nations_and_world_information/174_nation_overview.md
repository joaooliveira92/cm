...
Nation Overview is the primary information page for a country or football nation, combining associations, regions, reputation, language, competitions, clubs, national teams, rankings, calendar, and development context.

## 2. Primary user goals

- Open association, competitions, clubs, national teams, cities, and rankings
- Switch senior, youth, and gender-supported national contexts where modeled
- Review football calendar and registration context
- Compare nations
...
```text
+------------------------------------------------------------------------------+
| Nation identity, association, competitions, clubs, teams, rankings, language |
|------------------------------------------------------------------------------|
...
- Nation and football-association identity remain distinct
- Language and nationality information must avoid stereotypes
- Political or real-world commentary is outside this simulation screen
- Flags, emblems, and data require original or licensed assets
...
1. Nation and football-association identity remain distinct
2. Language and nationality information must avoid stereotypes
3. Political or real-world commentary is outside this simulation screen
4. Flags, emblems, and data require original or licensed assets
...
```text
Implement Nation Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify nation overview screen
```
