...
Competition Awards presents monthly, stage, seasonal, and tournament awards for players, managers, clubs, goals, teams, and officials where modeled.

## 2. Primary user goals

- Change award category, period, season, or stage
- Open nominees, winners, and supporting performances
- Review selection criteria where disclosed
- Navigate award history
...
```text
+------------------------------------------------------------------------------+
| Award categories, nominees, winners, period, voting or selection basis and h |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionAwardsModel {
...
- Awards derive from committed eligible evidence
- Nominee and winner states are distinct
- Hidden voting weights need not be exposed
- Ties and withdrawn awards require explicit states
...
1. Awards derive from committed eligible evidence
2. Nominee and winner states are distinct
3. Hidden voting weights need not be exposed
4. Ties and withdrawn awards require explicit states
...
```text
Implement Competition Awards for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition awards screen
```
