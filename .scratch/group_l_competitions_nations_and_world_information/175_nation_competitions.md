# Screen 175: Nation Competitions
...
Nation Competitions lists domestic leagues, cups, super cups, youth, reserve, regional, and supported non-league competitions organized by level, season, and status.

## 2. Primary user goals

- Browse competition pyramid and categories
- Open a competition edition
- Change season
- Trace promotion, relegation, and qualification links
...
```text
+------------------------------------------------------------------------------+
| Competition pyramid, levels, cups, regions, seasons, status and qualificatio |
|------------------------------------------------------------------------------|
...
```typescript
interface NationCompetitionsModel {
...
- Pyramid level and reputation are distinct
- Inactive or historical competitions remain labeled
- Regional paths are represented explicitly
- Loaded-detail scope must not be confused with competition existence
...
1. Pyramid level and reputation are distinct
2. Inactive or historical competitions remain labeled
3. Regional paths are represented explicitly
4. Loaded-detail scope must not be confused with competition existence
...
```text
Implement Nation Competitions for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify nation competitions screen
```
