# Screen 167: Competition Team Statistics
...
Competition Team Statistics compares participating clubs across results, goals, possession, discipline, attendance, form, home and away performance, and supported advanced metrics.

## 2. Primary user goals

- Choose metric category and stage
- Filter home, away, overall, and period scope
- Open a club or supporting match list
- Compare selected clubs
...
```text
+------------------------------------------------------------------------------+
| Club metrics, rank, form, home-away splits, coverage and definitions         |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionTeamStatisticsModel {
...
- Official competition rank remains separate from metric rank
- All clubs use the same metric definition and coverage
- Unavailable detailed statistics remain unavailable
- Tied values use deterministic display ordering
...
1. Official competition rank remains separate from metric rank
2. All clubs use the same metric definition and coverage
3. Unavailable detailed statistics remain unavailable
4. Tied values use deterministic display ordering
...
```text
Implement Competition Team Statistics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition team statistics screen
```
