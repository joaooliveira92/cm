# Screen 177: National Team Squad
...
National Team Squad manages or displays selected players, standby lists, positions, clubs, caps, goals, availability, eligibility, and call-up status for a national-team window.

## 2. Primary user goals

- Filter, sort, and open selected players
- Add, remove, replace, or move players to standby when authorized
- Review eligibility and release conflicts
- Submit a squad before the authoritative deadline
...
```text
+------------------------------------------------------------------------------+
| Selected squad, standby list, caps, clubs, availability, eligibility and cal |
|------------------------------------------------------------------------------|
...
```typescript
interface NationalTeamSquadModel {
...
- International eligibility is resolved authoritatively
- Call-up, acceptance, arrival, and match selection are distinct
- Club release rules and injuries may change availability
- Submission uses one squad and eligibility revision
...
1. International eligibility is resolved authoritatively
2. Call-up, acceptance, arrival, and match selection are distinct
3. Club release rules and injuries may change availability
4. Submission uses one squad and eligibility revision
...
```text
Implement National Team Squad for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify national team squad screen
```
