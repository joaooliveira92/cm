...
The Competition Table presents standings for league and group stages, including played, wins, draws, losses, goals, points, deductions, qualification zones, ties, form, and status.

## 2. Primary user goals

- Change season, stage, group, and table scope
- Sort supported informational columns without changing official rank
- Open a club or qualification rule
- Review deductions and tie-break explanations
...
```text
+------------------------------------------------------------------------------+
| Standings, points, goals, form, deductions, qualification zones and explanat |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionTableModel {
...
- Official rank is authoritative and not derived by renderer sorting
- Tie-break rules come from the competition edition
- Deductions require reason and effective revision
- Incomplete fixtures and unequal games played remain explicit
...
1. Official rank is authoritative and not derived by renderer sorting
2. Tie-break rules come from the competition edition
3. Deductions require reason and effective revision
4. Incomplete fixtures and unequal games played remain explicit
...
```text
Implement Competition Table for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition table screen
```
