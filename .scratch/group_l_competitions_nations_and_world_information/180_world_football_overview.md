# Screen 180: World Football Overview
...
World Football Overview is the global landing page for major competitions, nations, fixtures, results, rankings, transfer activity, awards, records, calendar events, and configurable followed entities.

## 2. Primary user goals

- Open featured competition, nation, club, team, player, or fixture
- Customize followed entities and regions
- Review major upcoming events and recent results
- Open global rankings, records, awards, and calendar
...
```text
+------------------------------------------------------------------------------+
| Major events, competitions, nations, rankings, fixtures, results, transfers  |
|------------------------------------------------------------------------------|
...
```typescript
interface WorldFootballOverviewModel {
...
- Featured content follows manager knowledge and privacy policy
- Global summaries use one coherent career revision
- Followed entities are manager-private preferences
- The overview must remain useful with a small loaded world
...
1. Featured content follows manager knowledge and privacy policy
2. Global summaries use one coherent career revision
3. Followed entities are manager-private preferences
4. The overview must remain useful with a small loaded world
...
```text
Implement World Football Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify world football overview screen
```
