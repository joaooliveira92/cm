...
World Rankings presents versioned rankings for national teams, clubs, competitions, managers, or supported coefficients with movement, points, period, methodology summary, and qualification relevance.

## 2. Primary user goals

- Choose supported ranking type and snapshot
- Search and open ranked entities
- Review movement and historical snapshots
- Open methodology and qualification context
...
```text
+------------------------------------------------------------------------------+
| Ranking type, position, movement, points, snapshot date, methodology and cov |
|------------------------------------------------------------------------------|
...
- Rankings are snapshot-based and not recalculated by the renderer
- Movement compares compatible snapshots
- Missing entities remain unranked rather than zero
- Methodology changes require versioned labels
...
1. Rankings are snapshot-based and not recalculated by the renderer
2. Movement compares compatible snapshots
3. Missing entities remain unranked rather than zero
4. Methodology changes require versioned labels
...
```text
Implement World Rankings for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify world rankings screen
```
