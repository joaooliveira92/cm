# Screen 142: Transfer Completion and Registration
...
Transfer Completion and Registration finalizes an agreed move by validating contracts, dates, medical or policy checks, budgets, squad capacity, work authorization, registration windows, and related employment transitions.

## 2. Primary user goals

- Review every outstanding completion condition
- Resolve registration, contract, capacity, or budget blockers
- Confirm or schedule completion at the valid date
- Navigate to squad numbering and registration after completion
...
```text
+------------------------------------------------------------------------------+
| Agreed terms, completion conditions, effective date, budgets, registration,  |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferCompletionPlan {
...
- Completion is one atomic career transaction
- A failed condition leaves prior employment intact
- Player, buying club, selling club, contracts, budgets, and registration update coherently
- Duplicate completion requests cannot create duplicate employment or payments
...
1. Completion is one atomic career transaction
2. A failed condition leaves prior employment intact
3. Player, buying club, selling club, contracts, budgets, and registration update coherently
4. Duplicate completion requests cannot create duplicate employment or payments
...
```text
Implement Transfer Completion and Registration for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer completion and registration screen
```
