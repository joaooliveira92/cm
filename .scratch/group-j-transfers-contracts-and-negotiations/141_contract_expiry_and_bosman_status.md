# Screen 141: Contract Expiry and Bosman Status
...
Contract Expiry and Bosman Status lists expiring agreements, eligibility for pre-contract approaches, option deadlines, release dates, compensation rules, and available club actions.

## 2. Primary user goals

- Filter by expiry period, squad, role, and eligibility
- Open renewal, release, option, or pre-contract workflows
- Review competition and jurisdiction rules
- Create reminders and squad-planner actions
...
Global Application Shell
  ...
  -> Contract Expiry and Bosman Status
...
```text
+------------------------------------------------------------------------------+
| Expiring contracts, option dates, pre-contract eligibility, compensation, re |
|------------------------------------------------------------------------------|
...
- Pre-contract eligibility comes from career rules, not real-world legal advice
- Contract option and expiry dates remain distinct
- Compensation and registration conditions are explicit
- A listed expiry does not mean the person is free immediately
...
1. Pre-contract eligibility comes from career rules, not real-world legal advice
2. Contract option and expiry dates remain distinct
3. Compensation and registration conditions are explicit
4. A listed expiry does not mean the person is free immediately
...
```text
Implement Contract Expiry and Bosman Status for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify contract expiry and bosman status screen
```
