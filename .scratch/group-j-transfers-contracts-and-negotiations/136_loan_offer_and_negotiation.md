# Screen 136: Loan Offer and Negotiation
...
Loan Offer and Negotiation configures temporary movement terms such as dates, wage contribution, monthly fee, optional or mandatory future fee, playing-time expectation, recall, cup eligibility, and restrictions.

## 2. Primary user goals

- Create or revise a loan proposal
- Set permitted financial and playing-time terms
- Review competition, registration, and recall implications
- Accept, reject, withdraw, or counter an incoming loan offer
...
```text
+------------------------------------------------------------------------------+
| Loan dates, wage share, fees, future option, playing time, recall, restricti |
|------------------------------------------------------------------------------|
...
```typescript
interface LoanNegotiationDraft {
...
- Loan employment and parent-club contract remain distinct
- Wage contributions total according to explicit policy
- Recall and future-purchase clauses require compatible dates
- Loan completion remains subject to player agreement and registration
...
1. Loan employment and parent-club contract remain distinct
2. Wage contributions total according to explicit policy
3. Recall and future-purchase clauses require compatible dates
4. Loan completion remains subject to player agreement and registration
...
```text
Implement Loan Offer and Negotiation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify loan offer and negotiation screen
```
