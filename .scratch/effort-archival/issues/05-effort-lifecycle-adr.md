...
ADR-0010 decided that the map closes at handoff and that post-handoff decisions live in the ADR
layer, but said nothing about what physically becomes of the effort directory afterward — which is
