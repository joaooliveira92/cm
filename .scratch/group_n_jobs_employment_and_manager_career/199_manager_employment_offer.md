# Screen 199: Manager Employment Offer
...
Manager Employment Offer presents a club or national-team contract proposal with role, duration, wage, bonuses, clauses, expectations, start date, staff authority, and response deadline.

## 2. Primary user goals

- Review the complete offer and employer expectations
- Compare the offer with current employment
- Accept, reject, delay, or negotiate where supported
- Open contract, club, objectives, and career-impact details
...
```text
+------------------------------------------------------------------------------+
| Employer, role, contract, authority, expectations, start date, deadline and  |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerEmploymentOfferModel {
...
- An offer is provisional until accepted and completed
- Current employment and compensation consequences are explicit
- Authority and responsibility scopes are separate from job title
...
1. An offer is provisional until accepted and completed
2. Current employment and compensation consequences are explicit
3. Authority and responsibility scopes are separate from job title
4. Expired offers become read-only
...
```text
Implement Manager Employment Offer for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager employment offer screen
```
