# Screen 207: Employment History and Career Milestones
...
Employment History and Career Milestones provides a chronological record of appointments, contracts, resignations, dismissals, unemployment, interviews, offers, qualifications, honours, and major career achievements.

## 2. Primary user goals

- Switch timeline, employment, applications, offers, contracts, and milestones views
- Open historical employer, competition, contract, or event
- Filter by period and event type
- Export a safe public career summary
...
```text
+------------------------------------------------------------------------------+
| Employment periods, events, contracts, offers, milestones, honours and quali |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerEmploymentHistoryModel {
...
- Canonical history is append-only except audited correction
- Private failed applications and offers follow manager visibility policy
- Overlapping compatible roles are modeled explicitly
- Historical employers retain stable fallback labels
...
1. Canonical history is append-only except audited correction
2. Private failed applications and offers follow manager visibility policy
3. Overlapping compatible roles are modeled explicitly
4. Historical employers retain stable fallback labels
...
```text
Implement Employment History and Career Milestones for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify employment history and career milestones screen
```
