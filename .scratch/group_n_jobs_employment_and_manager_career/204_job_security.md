...
Job Security presents current board confidence, expectation performance, pressure level, contract status, recent reasons, review points, and possible employment risks without exposing hidden dismissal formulas.

## 2. Primary user goals

- Review job-security dimensions and trends
- Open supporting objectives, results, finances, transfers, and board messages
- Compare current and historical review periods
...
```text
+------------------------------------------------------------------------------+
| Security band, confidence, objectives, contract, evidence, trends and review |
|------------------------------------------------------------------------------|
...
- Security bands do not expose hidden termination thresholds
- Evidence references committed facts
- Rumoured dismissal remains separate from authoritative board state
...
1. Security bands do not expose hidden termination thresholds
2. Evidence references committed facts
3. Rumoured dismissal remains separate from authoritative board state
4. The screen is read-only
...
```text
Implement Job Security for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify job security screen
```
