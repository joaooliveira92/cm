...
Staff Contract shows employment dates, wage, role, responsibilities, bonuses, clauses, renewal availability, termination cost, and future agreements.

## 2. Primary user goals

- Open renewal or role-change negotiation
- Review assigned responsibilities
- Inspect termination consequences
- Open club finances and staff profile
...
```text
| STAFF > CONTRACT | North United |
| Role: Assistant Manager | Expiry: 30 Jun 2007 |
| Wage: 8k EC/week | Responsibilities: Training, Team Talks |
| [Offer Renewal] [Change Role] [Terminate Contract] |
```
...
interface StaffContractModel {
  ...
  readonly terminationEstimate?: Money;
...
- Contract role and delegated responsibility are separate
- Money uses explicit currency and period
- Termination estimate is not applied until confirmed
- Confidential terms and competing offers obey visibility
...
1. Contract role and delegated responsibility are separate
2. Money uses explicit currency and period
3. Termination estimate is not applied until confirmed
4. Confidential terms and competing offers obey visibility
...
```text
Implement Staff Contract for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff contract screen
```
