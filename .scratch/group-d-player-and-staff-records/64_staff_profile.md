...
Staff Profile is the canonical overview for managers, coaches, scouts, medical staff, directors, and other football personnel.

## 2. Primary user goals

- Open profile tabs and linked entities
- Offer a contract or renew when authorized
- Assign coaching, scouting, medical, or delegated responsibilities
- Add to shortlist or compare staff
...
```text
| STAFF NAME | Role | Club | Availability |
| Overview | Attributes | Contract | History | Reports |
| Qualification | Reputation | Languages | Knowledge |
| [Offer Contract] [Assign Responsibility] |
```
...
```typescript
interface StaffProfileModel {
  readonly staffId: string;
  readonly revision: number;
  readonly identity: StaffIdentity;
  readonly employment: StaffEmploymentSummary;
  readonly roles: readonly StaffRoleSummary[];
  readonly capabilityView: StaffCapabilityView;
  readonly communication: StaffCommunicationSummary;
  readonly contract?: StaffContractSummary;
...
- Capability visibility follows knowledge and employment permissions
- Role qualification and current assignment are distinct
- A staff member may hold several supported responsibilities
- No real-person likeness or biography may be copied without rights
...
1. Capability visibility follows knowledge and employment permissions
2. Role qualification and current assignment are distinct
3. A staff member may hold several supported responsibilities
4. No real-person likeness or biography may be copied without rights
...
```text
Implement Staff Profile for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff profile screen
```
