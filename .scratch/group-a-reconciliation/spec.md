...
- Screen 2 (New Game) canonical file is `02_new_game.md`; the copy in `01_app_sheell.md` is redundant and not audited separately (source: `issues/04-audit-application-shell.md`, `issues/15-screen-2-new-game.md`)
