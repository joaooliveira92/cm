# Screen 73: Shirt Number Assignment
...
Shirt Number Assignment allocates competition-valid squad numbers to registered players and resolves duplicate, reserved, unavailable, or policy-restricted numbers.

## 2. Primary user goals

- Assign an available number
- Swap two eligible assignments
- Lock preferred assignments before auto-assignment
- Preview automatic assignment
- Validate and submit the number list
...
```text
+------------------------------------------------------------------------------+
| SHIRT NUMBERS                         Competition: First Division              |
|------------------------------------------------------------------------------|
| Player                 Number      Status                                     |
| Alex Keeper            [1 v]       Valid                                      |
| Morgan Centre          [5 v]       Valid                                      |
| Jordan Prospect        [-- v]      Number required                            |
|------------------------------------------------------------------------------|
| [Auto Assign] [Clear Unlocked] [Validate] [Submit Numbers]                    |
+------------------------------------------------------------------------------+
```
...
```typescript
interface ShirtNumberAssignmentDraft {
  readonly clubId: string;
  readonly competitionId: string;
  readonly registrationWindowId: string;
  readonly assignments: readonly ShirtNumberAssignment[];
  readonly lockedAssignments: readonly string[];
  readonly constraints: ShirtNumberConstraints;
...
- Numbers are competition-specific where rules require
- Duplicate, reserved, retired, and out-of-range numbers are blocked
- Auto-assignment is deterministic for one input revision
- Submission is atomic and does not alter player identity
...
1. Numbers are competition-specific where rules require
2. Duplicate, reserved, retired, and out-of-range numbers are blocked
3. Auto-assignment is deterministic for one input revision
4. Submission is atomic and does not alter player identity
...
```text
Implement Shirt Number Assignment for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify shirt number assignment screen
```
