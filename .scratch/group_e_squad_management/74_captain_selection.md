...
Captain Selection chooses the club captain and vice-captain from eligible squad members while presenting leadership, tenure, playing-time, language, relationship, and availability considerations.

## 2. Primary user goals

- Select captain and vice-captain
- Review candidate evidence and squad reaction preview
- Restore current assignments
- Confirm changes through a dedicated command
...
| CAPTAIN SELECTION                                                             |
|------------------------------------------------------------------------------|
| Captain      [Alex Veteran v]                                                 |
| Vice-captain [Morgan Centre v]                                                |
| Player            Leadership Tenure Playing time Recommendation               |
| Alex Veteran      Strong     8 yrs  Regular      Excellent choice             |
| [Review Impact] [Restore Previous] [Confirm]                                  |
+------------------------------------------------------------------------------+
```
...
```typescript
interface CaptaincyDraft {
  readonly clubId: string;
  readonly captainPlayerId?: string;
  readonly viceCaptainPlayerId?: string;
  readonly eligibility: readonly CaptainCandidateSummary[];
  readonly currentAssignments: CaptaincyAssignments;
...
- Recommendations are advisory and knowledge-limited
- Changing captaincy may affect relationships but does not guarantee reactions
- Eligibility and impact are recalculated at confirmation
...
1. Captain and vice-captain must be distinct
2. Recommendations are advisory and knowledge-limited
3. Changing captaincy may affect relationships but does not guarantee reactions
4. Eligibility and impact are recalculated at confirmation
...
```text
Implement Captain Selection for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify captain selection screen
```
