# Screen 78: Player Interaction and Grievance
...
Player Interaction and Grievance presents a player concern or manager-initiated conversation, available responses, promises, likely interpretation, deadlines, and resulting relationship changes.

## 2. Primary user goals

- Review the concern and committed context facts
- Select one supported response
- Review exact promise terms and deadline
- Cancel without changing the relationship
- Confirm one idempotent interaction result
...
Global Application Shell
  ...
  -> Player Interaction and Grievance
...
```text
+------------------------------------------------------------------------------+
| PLAYER INTERACTION: MORGAN CENTRE                                             |
|------------------------------------------------------------------------------|
| Concern: Wants more first-team football                                      |
| Context: 3 starts in the last 10 league matches                              |
|------------------------------------------------------------------------------|
| Response options                                                             |
| ( ) Promise more starts                                                      |
| ( ) Explain tactical competition                                             |
| ( ) Reject the concern                                                       |
| [Review Promise Terms] [Cancel] [Confirm Response]                            |
+------------------------------------------------------------------------------+
```
...
```typescript
interface PlayerInteractionDraft {
  readonly interactionId: string;
  readonly playerId: string;
  readonly managerId: string;
  readonly concernId?: string;
  readonly contextFacts: readonly InteractionContextFact[];
  readonly responseOptions: readonly InteractionResponseOption[];
  readonly selectedResponseId?: string;
  readonly promiseTerms?: PlayerPromiseTerms;
...
- Responses are generated from current context and policy
- Promises require measurable terms and deadlines
- Likely reaction is uncertain, not guaranteed
- Interaction text must avoid manipulation, harassment, or demeaning content
...
1. Responses are generated from current context and policy
2. Promises require measurable terms and deadlines
3. Likely reaction is uncertain, not guaranteed
4. Interaction text must avoid manipulation, harassment, or demeaning content
...
```text
Implement Player Interaction and Grievance for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player interaction and grievance screen
```
