...
Player Awards presents individual football awards for performance, development, position, age group, tournament, month, season, and career achievement.

## 2. Primary user goals

- Change category, competition, period, and season
- Open nominees, winner, player profile, and supporting matches
- Review disclosed selection criteria
- Compare current and historical winners
...
- Eligibility uses the award edition rules
- Transferred players are attributed correctly
- Ties and withdrawn awards use explicit states
- Hidden ability and potential are not exposed as award evidence
...
1. Eligibility uses the award edition rules
2. Transferred players are attributed correctly
3. Ties and withdrawn awards use explicit states
4. Hidden ability and potential are not exposed as award evidence
...
```text
Implement Player Awards for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player awards screen
```
