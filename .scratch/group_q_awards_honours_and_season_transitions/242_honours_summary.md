...
Honours Summary consolidates trophies, promotions, awards, records, distinctions, and milestones for a selected manager, player, staff member, club, team, or nation.

## 2. Primary user goals

- Choose the entity and honours scope
- Filter by category, competition, season, and role
- Open supporting competition, award, or event
- Export a safe honours summary
...
- Trophy, promotion, award, and record are different honour types
- Shared honours preserve correct entity attribution
- Historical corrections retain audit history
- Unknown historical coverage remains explicit
...
1. Trophy, promotion, award, and record are different honour types
2. Shared honours preserve correct entity attribution
3. Historical corrections retain audit history
4. Unknown historical coverage remains explicit
...
```text
Implement Honours Summary for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify honours summary screen
```
