# Screen 243: End of Season Review
...
End of Season Review summarizes sporting results, objectives, squad performance, development, transfers, finances, supporters, records, awards, and major career events.

## 2. Primary user goals

- Review each season domain and supporting evidence
- Open competitions, players, transfers, finances, and awards
- Compare with preseason expectations
- Create follow-up actions for the next season
...
- The review uses a frozen season-completion revision
- Narrative remains faithful to committed facts
- Analytical interpretations disclose uncertainty
- The review does not advance the season by itself
...
1. The review uses a frozen season-completion revision
2. Narrative remains faithful to committed facts
3. Analytical interpretations disclose uncertainty
4. The review does not advance the season by itself
...
```text
Implement End of Season Review for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify end of season review screen
```
