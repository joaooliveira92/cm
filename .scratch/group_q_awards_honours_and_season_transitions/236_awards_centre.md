...
The Awards Centre consolidates current nominations, winners, ceremonies, seasonal selections, honours, records, voting status, eligibility, and historical award navigation.

## 2. Primary user goals

- Browse awards by competition, nation, club, category, period, and season
- Open nominees, winners, supporting performances, and award rules
- Review upcoming ceremonies and unresolved selections
- Open honours and award history
...
- Nomination, voting, selection, announcement, and presentation remain distinct
- Awards use committed eligible evidence
- Unknown private voting remains undisclosed
- The centre never fabricates unsupported award categories
...
1. Nomination, voting, selection, announcement, and presentation remain distinct
2. Awards use committed eligible evidence
3. Unknown private voting remains undisclosed
4. The centre never fabricates unsupported award categories
...
```text
Implement Awards Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify awards centre screen
```
