...
**Blocked by:** [11](11-player-search-reads-by-scouting-progress.md) provides the shared search read and the result figures this screen composes; start comparison rows from that pool.
