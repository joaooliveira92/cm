# Screen 127: Recruitment Meetings
...
Recruitment Meetings provides a structured review of squad needs, shortlisted candidates, scout recommendations, budgets, transfer-window timing, and agreed follow-up actions.

## 2. Primary user goals

- Review agenda and current recruitment evidence
- Accept, reject, defer, or request more information on recommendations
- Assign follow-up owners and deadlines
- Create shortlist, scouting, or transfer actions
- Confirm one meeting outcome transaction
...
```text
+------------------------------------------------------------------------------+
| Meeting agenda, attendees, squad needs, candidates, recommendations, decisio |
|------------------------------------------------------------------------------|
...
```typescript
interface RecruitmentMeetingDraft {
...
- Meeting recommendations are advisory
- Decisions must reference current evidence revisions
- Private comments remain permission-restricted
- The meeting cannot commit a transfer without the dedicated negotiation workflow
...
1. Meeting recommendations are advisory
2. Decisions must reference current evidence revisions
3. Private comments remain permission-restricted
4. The meeting cannot commit a transfer without the dedicated negotiation workflow
...
```text
Implement Recruitment Meetings for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify recruitment meetings screen
```
