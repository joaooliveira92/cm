# Screen 130: Agent and Intermediary Information
...
Agent and Intermediary Information presents known representation, contact availability, client relationships, reputation, communication history, estimated expectations, and applicable negotiation restrictions.

## 2. Primary user goals

- Open represented players and relevant negotiations
- Review previous authorized communications
- Request availability or expectations through a dedicated action
- Record manager-private notes
- Block or report inappropriate contact according to policy
...
```text
+------------------------------------------------------------------------------+
| Representative identity, clients, relationship, contact status, expectations |
|------------------------------------------------------------------------------|
...
```typescript
interface AgentInformationModel {
...
- Representation data may be unknown or outdated
- Expectation estimates are not binding offers
- Private communications and contact data are restricted
- The game must not reproduce real unlicensed personal data
...
1. Representation data may be unknown or outdated
2. Expectation estimates are not binding offers
3. Private communications and contact data are restricted
4. The game must not reproduce real unlicensed personal data
...
```text
Implement Agent and Intermediary Information for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify agent and intermediary information screen
```
