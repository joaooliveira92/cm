# Screen 121: Scouting Assignment
...
Scouting Assignment creates a bounded task for an eligible scout or analyst to observe a player, team, competition, nation, region, event, or tactical question over a defined period.

## 2. Primary user goals

- Choose a supported assignment target and objective
- Select an eligible scout or scouting team
- Set duration, priority, travel, and reporting cadence
- Review workload, cost, coverage, and conflicts
- Submit, pause, reassign, or cancel the assignment
...
```text
+------------------------------------------------------------------------------+
| Target, scout, scope, duration, priority, travel, workload, expected coverag |
|------------------------------------------------------------------------------|
...
```typescript
interface ScoutingAssignmentDraft {
...
- Assignments do not guarantee complete knowledge
- Travel, language, region access, and competition schedules affect coverage
- A scout cannot exceed policy workload without an explicit warning or block
- Cancellation preserves reports already completed
...
1. Assignments do not guarantee complete knowledge
2. Travel, language, region access, and competition schedules affect coverage
3. A scout cannot exceed policy workload without an explicit warning or block
4. Cancellation preserves reports already completed
...
```text
Implement Scouting Assignment for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify scouting assignment screen
```
