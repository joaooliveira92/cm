# Screen 131: Trial and Assessment
...
Trial and Assessment manages invitations, eligibility, dates, temporary training access, evaluation objectives, medical or registration prerequisites, reports, and final decisions for trial players or staff.

## 2. Primary user goals

- Invite an eligible person to trial
- Set dates, squad access, and evaluation goals
- Assign coaches, scouts, or medical evaluators
- Review interim and final reports
- End, extend, reject, or progress to a contract workflow
...
```text
+------------------------------------------------------------------------------+
| Trial target, dates, eligibility, club access, objectives, assigned evaluato |
|------------------------------------------------------------------------------|
...
```typescript
interface TrialAssessmentDraft {
...
- A trial does not create employment or registration automatically
- Medical and jurisdiction rules are authoritative
- Trial access exposes only policy-approved club information
- Final decisions remain separate from contract negotiation
...
1. A trial does not create employment or registration automatically
2. Medical and jurisdiction rules are authoritative
3. Trial access exposes only policy-approved club information
4. Final decisions remain separate from contract negotiation
...
```text
Implement Trial and Assessment for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify trial and assessment screen
```
