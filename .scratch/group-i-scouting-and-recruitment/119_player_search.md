...
Player Search finds footballers through permission-aware and knowledge-limited criteria such as name, age, position, role, nationality, contract, transfer status, value range, wage estimate, availability, attributes, statistics, and scouting status.

## 2. Primary user goals

- Build simple or advanced player criteria
- Run, cancel, refine, save, rename, or delete a search
- Sort and filter knowledge-limited results
- Open player profiles and scout reports
- Add players to a shortlist or assign scouting
...
```text
+------------------------------------------------------------------------------+
| Search criteria, result grid, knowledge confidence, saved searches, shortlis |
|------------------------------------------------------------------------------|
...
- Search predicates must not expose hidden exact values
- Unknown values do not become false, zero, or worst
- Result counts must not leak inaccessible players
- Attribute criteria use visible ranges and confidence policy
...
1. Search predicates must not expose hidden exact values
2. Unknown values do not become false, zero, or worst
3. Result counts must not leak inaccessible players
4. Attribute criteria use visible ranges and confidence policy
...
```text
Implement Player Search for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player search screen
```
