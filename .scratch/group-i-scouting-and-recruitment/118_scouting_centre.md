...
The Scouting Centre is the manager’s consolidated recruitment dashboard. It summarizes active assignments, recruitment focuses, newly delivered reports, shortlist movement, staff workload, regional knowledge, and urgent transfer-window actions.

## 2. Primary user goals

- Review new and updated reports
- Open active assignments and recruitment focuses
- Inspect scout workload and geographic coverage
- Open player search, staff search, shortlists, and squad planner
- Resolve expired, blocked, or understaffed recruitment tasks
...
```text
+------------------------------------------------------------------------------+
| Assignments, reports, priorities, shortlist changes, scout workload, knowled |
|------------------------------------------------------------------------------|
...
- The centre must not reveal unscouted exact attributes
- Reports and recommendations remain tied to author, confidence, and freshness
- Assignment status and report availability are separate
- Alerts must link to valid corrective workflows
...
1. The centre must not reveal unscouted exact attributes
2. Reports and recommendations remain tied to author, confidence, and freshness
3. Assignment status and report availability are separate
4. Alerts must link to valid corrective workflows
...
```text
Implement Scouting Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify scouting centre screen
```
