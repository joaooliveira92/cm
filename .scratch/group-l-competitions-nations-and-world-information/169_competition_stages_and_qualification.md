# Screen 169: Competition Stages and Qualification
...
Competition Stages and Qualification visualizes rounds, groups, brackets, advancement paths, relegation, continental qualification, playoffs, byes, and unresolved dependencies.

## 2. Primary user goals

- Open a stage, group, round, or participant
- Trace qualification and elimination paths
- Switch simplified and detailed views
- Review unresolved draws or dependencies
...
Global Application Shell
  ...
  -> Competition Stages and Qualification
...
```text
+------------------------------------------------------------------------------+
| Stage graph, participants, paths, qualification slots, dependencies and stat |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionStagesModel {
...
- Every visual path has a textual list equivalent
- Qualification is driven by committed standings and results
- Conditional paths remain provisional
- Byes, seeded entries, and repechage states are explicit
...
1. Every visual path has a textual list equivalent
2. Qualification is driven by committed standings and results
3. Conditional paths remain provisional
4. Byes, seeded entries, and repechage states are explicit
...
```text
Implement Competition Stages and Qualification for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition stages and qualification screen
```
