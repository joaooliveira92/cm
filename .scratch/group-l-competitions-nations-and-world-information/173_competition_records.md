# Screen 173: Competition Records
...
Competition Records presents all-time and edition-specific records for clubs, players, managers, matches, goals, appearances, streaks, attendances, discipline, and transfers where relevant.

## 2. Primary user goals

- Switch category, edition, stage, and all-time scope
- Open record holder and supporting event
- Review tied and superseded records
- Compare current edition with historical records
...
```text
+------------------------------------------------------------------------------+
| Record categories, holders, values, dates, matches, scope and tie status     |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionRecordsModel {
...
- Records use normalized definitions and units
- Ties list valid holders or disclose truncation
...
1. Records use normalized definitions and units
2. Ties list valid holders or disclose truncation
3. Unsupported historical coverage is explicit
4. Corrections preserve prior audit history
...
```text
Implement Competition Records for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition records screen
```
