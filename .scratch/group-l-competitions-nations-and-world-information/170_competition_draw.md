...
Competition Draw performs or presents a seeded, rule-constrained assignment of clubs or nations into groups, ties, brackets, hosts, or venues.

## 2. Primary user goals

- Review pots, seeds, exclusions, and constraints
- Run or observe the draw when authorized
- Step through results or reveal the completed draw
- Open assigned participants and resulting fixtures
...
```text
+------------------------------------------------------------------------------+
| Pots, seeds, participants, constraints, draw order, results and audit refere |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionDrawModel {
...
- The authoritative draw uses a deterministic auditable random stream
- Renderer animation never determines results
- Constraints are validated before and after assignment
- A completed draw is immutable except audited correction
...
1. The authoritative draw uses a deterministic auditable random stream
2. Renderer animation never determines results
3. Constraints are validated before and after assignment
4. A completed draw is immutable except audited correction
...
```text
Implement Competition Draw for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition draw screen
```
