# Screen 166: Competition Player Statistics
...
Competition Player Statistics ranks eligible players across appearances, minutes, goals, assists, ratings, cards, clean sheets, and position-specific metrics.

## 2. Primary user goals

- Select metric, position, club, stage, and minimum-participation profile
- Sort and page through players
- Open a player, club, or supporting matches
- Compare leaders across seasons where supported
...
```text
+------------------------------------------------------------------------------+
| Player leaders, clubs, appearances, metrics, rankings, coverage and eligibil |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionPlayerStatisticsModel {
...
- Unknown or unavailable metrics do not become zero
- Minimum-participation premises are named policy values
- Transfers within an edition must not double-count players
- Results-only competitions expose only supported metrics
...
1. Unknown or unavailable metrics do not become zero
2. Minimum-participation premises are named policy values
3. Transfers within an edition must not double-count players
4. Results-only competitions expose only supported metrics
...
```text
Implement Competition Player Statistics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition player statistics screen
```
