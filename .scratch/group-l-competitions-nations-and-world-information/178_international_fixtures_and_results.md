# Screen 178: International Fixtures and Results
...
International Fixtures and Results presents national-team matches across friendlies, qualifiers, tournaments, youth levels, and supported competitions.

## 2. Primary user goals

- Filter by team, competition, level, date, and status
- Open match preview, report, squad, opponent, or tournament
- Review qualification consequences
- Switch fixtures and results views
...
```text
+------------------------------------------------------------------------------+
| Dates, opponents, competitions, venues, status, scores, reports and qualific |
|------------------------------------------------------------------------------|
...
```typescript
interface InternationalFixturesResultsModel {
...
- Neutral venues and host status are explicit
- International windows and club conflicts remain visible
- Result detail follows simulation coverage
- Awarded, abandoned, extra-time, and shootout outcomes are distinct
...
1. Neutral venues and host status are explicit
2. International windows and club conflicts remain visible
3. Result detail follows simulation coverage
4. Awarded, abandoned, extra-time, and shootout outcomes are distinct
...
```text
Implement International Fixtures and Results for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international fixtures and results screen
```
