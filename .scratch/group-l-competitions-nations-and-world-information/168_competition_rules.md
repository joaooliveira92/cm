...
Competition Rules explains format, eligibility, registration, substitutions, tie-breakers, points, discipline, scheduling, prize structure, qualification, and special edition policies.

## 2. Primary user goals

- Navigate rule categories
- Open referenced stages, registration windows, or qualification destinations
- Compare current and prior edition rules
- Copy a safe rule summary
...
```text
+------------------------------------------------------------------------------+
| Format, eligibility, squad rules, tie-breaks, discipline, prizes, qualificat |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionRulesModel {
...
- Rules are versioned by competition edition
- The screen explains simulation rules and is not legal advice
- Effective dates and exceptions are explicit
- Rule text is generated from structured policy facts
...
1. Rules are versioned by competition edition
2. The screen explains simulation rules and is not legal advice
3. Effective dates and exceptions are explicit
4. Rule text is generated from structured policy facts
...
```text
Implement Competition Rules for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition rules screen
```
