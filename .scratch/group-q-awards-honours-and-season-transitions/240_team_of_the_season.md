...
Team of the Season selects and displays eligible players and staff in a rule-defined formation or roster based on the award period and supported evidence.

## 2. Primary user goals

- Switch competition, season, formation, and award variant
- Open selected people and supporting performances
- Review substitutes, honourable mentions, and selection basis
- Navigate historical teams
...
- The selection is produced by a trusted award service
- Position and role eligibility use edition rules
- A visual formation has an accessible ordered-list equivalent
- Ties and alternative selections are explicit
...
1. The selection is produced by a trusted award service
2. Position and role eligibility use edition rules
3. A visual formation has an accessible ordered-list equivalent
4. Ties and alternative selections are explicit
...
```text
Implement Team of the Season for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify team of the season screen
```
