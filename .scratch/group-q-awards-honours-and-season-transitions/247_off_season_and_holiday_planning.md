# Screen 247: Off-Season and Holiday Planning
...
Off-Season and Holiday Planning configures player and staff holidays, reporting dates, rest periods, tours, camps, friendlies, medical follow-ups, and preparation milestones.

## 2. Primary user goals

- Set permitted holiday and reporting-date policies
- Review player and staff exceptions
- Plan camps, tours, and friendly windows
- Submit the off-season plan
...
- Rest and medical restrictions override ordinary training plans
- International commitments are preserved
- Dates use named policy constraints
- Plans are revalidated after fixture or competition changes
...
1. Rest and medical restrictions override ordinary training plans
2. International commitments are preserved
3. Dates use named policy constraints
4. Plans are revalidated after fixture or competition changes
...
```text
Implement Off-Season and Holiday Planning for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify off season and holiday planning screen
```
