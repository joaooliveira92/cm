# Screen 246: Season Transition and Competition Rollover
...
Season Transition and Competition Rollover performs the authoritative advance from a completed season into the next edition, including competition membership, calendars, contracts, ages, budgets, records, rules, and scheduled events.

## 2. Primary user goals

- Review transition prerequisites and blockers
- Inspect competition rollovers and club destinations
- Start, monitor, pause where safe, or recover the transition
- Open the transition report after completion
...
- The transition is resumable, transactional, and idempotent
- No partial completion may leave contradictory canonical state
- Rule and format changes are versioned by edition
- The renderer cannot simulate or commit rollover changes
...
1. The transition is resumable, transactional, and idempotent
2. No partial completion may leave contradictory canonical state
3. Rule and format changes are versioned by edition
4. The renderer cannot simulate or commit rollover changes
...
```text
Implement Season Transition and Competition Rollover for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify season transition and competition rollover screen
```
