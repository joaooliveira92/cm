# Screen 239: Team and Club Awards
...
Team and Club Awards presents collective recognition such as team achievement, fair play, development, performance, community, and competition-specific distinctions.

## 2. Primary user goals

- Browse categories, nominees, winners, and seasons
- Open clubs, teams, competitions, and supporting evidence
- Review award criteria and eligibility
- Compare historical recipients
...
- Team and legal club identity remain distinct where required
- Collective awards reference committed evidence
- Community-style categories avoid unsupported real-world claims
- Award labels and assets must be original or licensed
...
1. Team and legal club identity remain distinct where required
2. Collective awards reference committed evidence
3. Community-style categories avoid unsupported real-world claims
4. Award labels and assets must be original or licensed
...
```text
Implement Team and Club Awards for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify team and club awards screen
```
