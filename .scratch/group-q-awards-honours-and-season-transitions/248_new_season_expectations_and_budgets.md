# Screen 248: New Season Expectations and Budgets
...
New Season Expectations and Budgets presents board objectives, competition expectations, transfer and wage budgets, staffing limits, facility projects, and available manager responses.

## 2. Primary user goals

- Review objectives, priorities, and budget changes
- Open supporting finance and competition context
- Accept or discuss supported expectations
- Create squad, recruitment, and planning actions
...
- Expectations and contractual promises remain distinct
- Budgets use explicit currency and effective dates
- Forecasts are not guarantees
- Responses use professional constrained content
...
1. Expectations and contractual promises remain distinct
2. Budgets use explicit currency and effective dates
3. Forecasts are not guarantees
4. Responses use professional constrained content
...
```text
Implement New Season Expectations and Budgets for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify new season expectations and budgets screen
```
