# Screen 138: Player Contract Negotiation
...
Player Contract Negotiation manages the player or representative’s response, counterproposal, demands, deadlines, patience, competing interest, and final agreement.

## 2. Primary user goals

- Review demands and prior proposals
- Accept, reject, withdraw, delay, or counter where permitted
- Adjust compatible terms without losing prior history
- Review affordability and registration implications
...
```text
+------------------------------------------------------------------------------+
| Offer history, demands, counterproposal, deadline, interest, promises, agree |
|------------------------------------------------------------------------------|
...
```typescript
interface PlayerContractNegotiationModel {
...
- Negotiation mood must not be manipulated through hidden UI tricks
- Competing interest may be uncertain or private
- Agreed terms remain provisional until all conditions complete
- Expired negotiations cannot be revived without a new authorized approach
...
1. Negotiation mood must not be manipulated through hidden UI tricks
2. Competing interest may be uncertain or private
3. Agreed terms remain provisional until all conditions complete
4. Expired negotiations cannot be revived without a new authorized approach
...
```text
Implement Player Contract Negotiation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player contract negotiation screen
```
