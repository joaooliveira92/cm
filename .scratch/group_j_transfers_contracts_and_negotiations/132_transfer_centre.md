...
The Transfer Centre is the operational dashboard for incoming and outgoing offers, active negotiations, loans, contract talks, future transfers, deadlines, budgets, registrations, and transfer-window alerts.

## 2. Primary user goals

- Review incoming, outgoing, pending, completed, failed, and future transactions
- Open a player, club, agent, negotiation, contract, or registration workflow
- Filter activity by direction, type, status, deadline, and squad priority
- Resolve expiring offers, budget conflicts, and incomplete registrations
...
```text
+------------------------------------------------------------------------------+
| Offers, negotiations, loans, contracts, deadlines, budgets, registrations, f |
|------------------------------------------------------------------------------|
...
- Offer, negotiation, agreement, completion, and registration are distinct states
- Private terms obey manager and club permissions
- Dashboard totals use one transfer-state revision
- No row action may bypass the dedicated negotiation workflow
...
1. Offer, negotiation, agreement, completion, and registration are distinct states
2. Private terms obey manager and club permissions
3. Dashboard totals use one transfer-state revision
4. No row action may bypass the dedicated negotiation workflow
...
```text
Implement Transfer Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer centre screen
```
