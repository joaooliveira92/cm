# Screen 143: Transfer Cancellation and Withdrawal
...
Transfer Cancellation and Withdrawal ends an offer, negotiation, loan, contract proposal, or agreed-but-not-completed deal according to its current stage and cancellation rights.

## 2. Primary user goals

- Review whether withdrawal or cancellation is permitted
- Inspect financial, relationship, and squad consequences
- Confirm cancellation with appropriate strength
- Return to the related transfer or contract record
...
Global Application Shell
  ...
  -> Transfer Cancellation and Withdrawal
...
```text
+------------------------------------------------------------------------------+
| Transaction stage, cancellation rights, consequences, sunk costs, deadlines, |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferCancellationPlan {
...
- Withdrawal, mutual cancellation, failed condition, and expiry are distinct outcomes
- Completed transfers cannot be cancelled through this workflow
- Irrecoverable costs must be disclosed before confirmation
- Cancellation uses the current transaction revision
...
1. Withdrawal, mutual cancellation, failed condition, and expiry are distinct outcomes
2. Completed transfers cannot be cancelled through this workflow
3. Irrecoverable costs must be disclosed before confirmation
4. Cancellation uses the current transaction revision
...
```text
Implement Transfer Cancellation and Withdrawal for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer cancellation and withdrawal screen
```
