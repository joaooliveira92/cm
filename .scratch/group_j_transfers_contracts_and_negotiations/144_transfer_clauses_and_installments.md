# Screen 144: Transfer Clauses and Installments
...
Transfer Clauses and Installments defines, validates, and explains structured financial terms such as scheduled payments, appearance bonuses, achievement clauses, sell-on percentages, buybacks, and future options.

## 2. Primary user goals

- Add a supported clause type
- Edit trigger, amount, percentage, date, count, or cap
- Reorder and remove draft terms
- Review clause compatibility and budget effects
- Apply clauses to the parent draft
...
Global Application Shell
  ...
  -> Transfer Clauses and Installments
...
```text
+------------------------------------------------------------------------------+
| Clause list, timing, triggers, caps, percentages, installment schedule, pres |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferClauseEditorModel {
...
- Clause definitions come from versioned policy schemas
- Percentages, amounts, triggers, and dates use bounded typed values
- Mutually exclusive clauses require explicit conflict resolution
- Future contingent amounts are never presented as guaranteed fees
...
1. Clause definitions come from versioned policy schemas
2. Percentages, amounts, triggers, and dates use bounded typed values
3. Mutually exclusive clauses require explicit conflict resolution
4. Future contingent amounts are never presented as guaranteed fees
...
```text
Implement Transfer Clauses and Installments for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer clauses and installments screen
```
