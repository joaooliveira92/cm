# Screen 145: Transfer Budget and Wage Budget Review
...
Transfer Budget and Wage Budget Review presents the financial effect of a proposed transfer or contract across current funds, committed installments, wages, bonuses, agent fees, taxes or fees where modeled, and future projections.

## 2. Primary user goals

- Review guaranteed, contingent, immediate, and future costs
- Switch club-native and preferred display currency
- Open finance, transfer, contract, and budget-rule details
- Return to revise unaffordable terms
...
Global Application Shell
  ...
  -> Transfer Budget and Wage Budget Review
...
```text
+------------------------------------------------------------------------------+
| Current budget, proposal impact, committed costs, wage effect, future period |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferBudgetReviewModel {
...
- Canonical money retains currency and minor units
- Future projections are estimates
- Budget availability is revalidated at submission
- Viewer permissions control exact financial visibility
...
1. Canonical money retains currency and minor units
2. Future projections are estimates
3. Budget availability is revalidated at submission
4. Viewer permissions control exact financial visibility
...
```text
Implement Transfer Budget and Wage Budget Review for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer budget and wage budget review screen
```
