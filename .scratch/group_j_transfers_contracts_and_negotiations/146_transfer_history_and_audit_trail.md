# Screen 146: Transfer History and Audit Trail
...
Transfer History and Audit Trail presents an immutable chronological record of offers, revisions, decisions, agreements, failures, payments, clauses, registrations, and authorized actors for one transaction.

## 2. Primary user goals

- Review chronological transaction events
- Compare offer and contract revisions
- Open authorized linked entities and documents
- Export a safe non-sensitive transaction summary
- Inspect correction or reversal events
...
```text
+------------------------------------------------------------------------------+
| Timeline, proposal revisions, decisions, payments, clauses, registration, ac |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferAuditTrailModel {
...
- Audit history is append-only except explicit redaction policy
- Private monetary and negotiation data obey viewer permissions
- System actors and human actors are distinguishable
- Exports exclude secrets, tokens, private notes, and hidden data
...
1. Audit history is append-only except explicit redaction policy
2. Private monetary and negotiation data obey viewer permissions
3. System actors and human actors are distinguishable
4. Exports exclude secrets, tokens, private notes, and hidden data
...
```text
Implement Transfer History and Audit Trail for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer history and audit trail screen
```
