...
Contract Renewal reviews an existing player or staff contract and negotiates an extension while preserving current terms until the new agreement becomes effective.

## 2. Primary user goals

- Compare current and proposed terms
- Start or continue renewal negotiation
- Set future-effective terms where supported
- Withdraw the offer without altering the current contract
- Review expiry and replacement planning
...
```text
+------------------------------------------------------------------------------+
| Current contract, proposed extension, role, wage, clauses, deadlines, compar |
|------------------------------------------------------------------------------|
...
```typescript
interface ContractRenewalModel {
...
- The existing contract remains valid until an extension is completed
- Renewal start and effective dates are explicit
- Removed clauses require explicit comparison
- Promises and role changes follow the same rules as new contracts
...
1. The existing contract remains valid until an extension is completed
2. Renewal start and effective dates are explicit
3. Removed clauses require explicit comparison
4. Promises and role changes follow the same rules as new contracts
...
```text
Implement Contract Renewal for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify contract renewal screen
```
