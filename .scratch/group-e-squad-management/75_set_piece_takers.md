...
Set-Piece Takers assigns ordered player lists for penalties, direct free kicks, indirect free kicks, corners, long throws, and other competition-supported restarts.

## 2. Primary user goals

- Select a set-piece category
- Add, remove, and reorder takers
- Apply side-specific assignments
- Preview automatic suggestions
- Save to club or tactic scope according to policy
...
| SET-PIECE TAKERS                                                              |
|------------------------------------------------------------------------------|
| [Penalties] [Direct Free Kicks] [Corners Left] [Corners Right] [Long Throws]   |
| Priority Player              Suitability Availability                         |
| 1        Alex Forward        Strong      Available                            |
| 2        Morgan Creator      Good        Available                            |
| [Move Up] [Move Down] [Auto Suggest] [Save Assignments]                       |
+------------------------------------------------------------------------------+
```
...
```typescript
interface SetPieceAssignmentsDraft {
  readonly clubId: string;
  readonly tacticId?: string;
  readonly categories: Readonly<Record<string, readonly SetPieceTakerAssignment[]>>;
  readonly eligiblePlayers: readonly SetPieceCandidateSummary[];
...
- Ordered priority is explicit
- Unavailable players remain in saved priority but are skipped for the match
- Suitability respects visible knowledge
- Assignment scope between club and tactic must be clear
...
1. Ordered priority is explicit
2. Unavailable players remain in saved priority but are skipped for the match
3. Suitability respects visible knowledge
4. Assignment scope between club and tactic must be clear
...
```text
Implement Set-Piece Takers for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify set piece takers screen
```
