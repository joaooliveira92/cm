...
Squad Registration selects players for a competition registration window while enforcing squad size, age, nationality, homegrown, club-trained, loan, and eligibility rules.

## 2. Primary user goals

- Select and deselect eligible players
- Inspect the reason for eligibility or exemption
- Auto-select through a preview
- Save an incomplete draft
- Submit before the authoritative deadline
...
```text
+------------------------------------------------------------------------------+
| SQUAD REGISTRATION                   First Division | Deadline 31 August       |
|------------------------------------------------------------------------------|
| Registered 23/25 | Homegrown 7/8 | Club-trained 3/4 | U21 exempt 5           |
| Player            Selected Eligibility        Homegrown Contract              |
| Alex Keeper       [x]      Eligible           Yes       2007                  |
| Jordan Prospect   [ ]      U21 exempt         Yes       2008                  |
| [Auto Select] [Validate] [Save Draft] [Submit Registration]                   |
+------------------------------------------------------------------------------+
```
...
```typescript
interface SquadRegistrationDraft {
  readonly registrationId: string;
  readonly clubId: string;
  readonly competitionId: string;
  readonly windowId: string;
  readonly selectedPlayerIds: readonly string[];
  readonly exemptPlayerIds: readonly string[];
  readonly constraints: RegistrationConstraints;
...
- Exempt, registered, eligible, and selectable are distinct
- Rules come from the competition and season
- Submission is atomic and deadline-aware
- A player cannot be made eligible by renderer state
...
1. Exempt, registered, eligible, and selectable are distinct
2. Rules come from the competition and season
3. Submission is atomic and deadline-aware
4. A player cannot be made eligible by renderer state
...
```text
Implement Squad Registration for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify squad registration screen
```
