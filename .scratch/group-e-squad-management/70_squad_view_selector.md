...
The Squad View Selector changes which predefined or custom columns are shown in squad lists, such as selection, contract, form, fitness, attributes, development, transfer, and registration information.

## 2. Primary user goals

- Apply a built-in view preset
- Add, remove, reorder, and resize permitted columns
- Save, rename, duplicate, or delete a personal view
- Restore the current view to its default
...
```text
+------------------------------------------------------------------------------+
| SQUAD VIEW: [Selection v]                                                     |
|------------------------------------------------------------------------------|
| Presets: Selection | Fitness | Form | Contract | Transfer | Development       |
| Visible columns: [x] Position [x] Condition [x] Form [ ] Wage [ ] Value       |
| [Save Custom View] [Restore Default] [Apply]                                 |
+------------------------------------------------------------------------------+
```
...
```typescript
interface SquadViewDefinition {
  readonly viewId: string;
  readonly ownerManagerId?: string;
  readonly displayName: string;
  readonly columnIds: readonly string[];
  readonly columnWidths: Readonly<Record<string, number>>;
  readonly sortDefinition?: PlayerSortDefinition;
...
- Views alter presentation only
- Hidden knowledge cannot be exposed by adding a column
- Column definitions and formats are policy-driven
- Custom views are manager-private unless explicitly shared
...
1. Views alter presentation only
2. Hidden knowledge cannot be exposed by adding a column
3. Column definitions and formats are policy-driven
4. Custom views are manager-private unless explicitly shared
...
```text
Implement Squad View Selector for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify squad view selector screen
```
