# Screen 77: Availability and Eligibility
...
Availability and Eligibility consolidates why each player can or cannot be selected for a match, competition, squad, registration, or training activity.

## 2. Primary user goals

- Filter by available, doubtful, and ineligible states
- Open a detailed reason and supporting rule
- Navigate to injury, discipline, registration, contract, or loan information
- Return to squad selection with context preserved
...
| AVAILABILITY AND ELIGIBILITY                                                  |
|------------------------------------------------------------------------------|
| Player            Match     Registration Injury Ban Cup-tied Other            |
| Alex Keeper       Available Registered   No     No  No        -               |
| Morgan Centre     Doubtful  Registered   Yes    No  No        Fitness test    |
| Jordan Loan       Ineligible Registered  No     No  Yes       Cup-tied        |
| [Open Reason] [Competition Rules] [Medical] [Discipline]                      |
+------------------------------------------------------------------------------+
```
...
```typescript
interface PlayerEligibilityMatrix {
  readonly clubId: string;
  readonly fixtureId?: string;
  readonly competitionId?: string;
  readonly rows: readonly PlayerEligibilityRow[];
...
- Medical availability and legal eligibility are separate
- Multiple blocking reasons remain visible
- Cup-tied, suspended, unregistered, on loan, and international duty states are distinct
- Eligibility is resolved authoritatively for the selected fixture
...
1. Medical availability and legal eligibility are separate
2. Multiple blocking reasons remain visible
3. Cup-tied, suspended, unregistered, on loan, and international duty states are distinct
4. Eligibility is resolved authoritatively for the selected fixture
...
```text
Implement Availability and Eligibility for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify availability and eligibility screen
```
