# Screen 201: Accept Managerial Appointment
...
Accept Managerial Appointment completes a manager’s move into a club or national-team role by validating contract, start date, current employment, authority, career restrictions, and employer transition.

## 2. Primary user goals

- Review the final appointment and transition consequences
- Resolve resignation, compensation, or start-date conditions
- Confirm appointment at a safe simulation boundary
- Navigate to the new employer onboarding flow
...
```text
+------------------------------------------------------------------------------+
| Accepted offer, current role, transition, start date, authority, contract an |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerAppointmentPlan {
...
- Appointment is an atomic career transaction
- The prior employment closes coherently when required
- The new employer receives valid manager control and authority
- Duplicate completion cannot create overlapping employment
...
1. Appointment is an atomic career transaction
2. The prior employment closes coherently when required
3. The new employer receives valid manager control and authority
4. Duplicate completion cannot create overlapping employment
...
```text
Implement Accept Managerial Appointment for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify accept managerial appointment screen
```
