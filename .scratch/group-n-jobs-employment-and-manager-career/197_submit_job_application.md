# Screen 197: Submit Job Application
...
Submit Job Application creates a formal manager application with availability, current-employment disclosure, supported supporting statements, delegation limits, and withdrawal rules.

## 2. Primary user goals

- Review eligibility and application requirements
- Select a constrained professional supporting statement
- Declare supported availability and current-employment context
- Submit, save, or withdraw the application
...
```text
+------------------------------------------------------------------------------+
| Vacancy, candidate, availability, employment, supporting statement, deadline |
|------------------------------------------------------------------------------|
...
- Applications use constrained professional content rather than unrestricted persuasion
- Current employer visibility follows policy
- Submission does not guarantee an interview
- Duplicate submissions return the original application
...
1. Applications use constrained professional content rather than unrestricted persuasion
2. Current employer visibility follows policy
3. Submission does not guarantee an interview
4. Duplicate submissions return the original application
...
```text
Implement Submit Job Application for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify submit job application screen
```
