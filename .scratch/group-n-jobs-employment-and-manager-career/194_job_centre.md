...
The Job Centre is the manager-career dashboard for vacancies, applications, interviews, offers, current employment, job security, qualifications, reputation, and career alerts.

## 2. Primary user goals

- Review vacancies, active applications, interviews, and offers
- Open job security, reputation, qualifications, and employment history
- Withdraw eligible applications
- Review deadlines and career opportunities
...
```text
+------------------------------------------------------------------------------+
| Vacancies, applications, interviews, offers, security, qualifications and ca |
|------------------------------------------------------------------------------|
...
- Vacancy, application, interview, offer, appointment, resignation, and dismissal are distinct states
- Private club interest follows visibility policy
- The centre uses one manager-career revision
- No dashboard shortcut may bypass a dedicated employment workflow
...
1. Vacancy, application, interview, offer, appointment, resignation, and dismissal are distinct states
2. Private club interest follows visibility policy
3. The centre uses one manager-career revision
4. No dashboard shortcut may bypass a dedicated employment workflow
...
```text
Implement Job Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify job centre screen
```
