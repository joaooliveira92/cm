# Screen 206: Manager Qualifications and Coaching Badges
...
Manager Qualifications and Coaching Badges presents current qualifications, course eligibility, enrollment, cost, duration, employer approval, study progress, and completion history.

## 2. Primary user goals

- Review current and historical qualifications
- Open eligible courses and requirements
- Request employer funding or permission
- Enroll, withdraw, or review progress where permitted
...
```text
+------------------------------------------------------------------------------+
| Qualifications, eligibility, courses, cost, duration, approval, progress and |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerQualificationModel {
...
- Qualifications use fictional or licensed accreditation structures
- Enrollment and completion are distinct states
- Costs use explicit currency and authorization
- Study outcomes and timing follow career policy
...
1. Qualifications use fictional or licensed accreditation structures
2. Enrollment and completion are distinct states
3. Costs use explicit currency and authorization
4. Study outcomes and timing follow career policy
...
```text
Implement Manager Qualifications and Coaching Badges for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager qualifications and coaching badges screen
```
