# Screen 256: Game Speed and Continue Policy
...
Game Speed and Continue Policy controls simulation speed, pause rights, continue deadlines, mandatory stops, match-day coordination, absence behavior, and automatic advancement rules.

## 2. Primary user goals

- Choose a supported timing policy
- Configure pause and continue permissions
- Set named absence and timeout profiles
- Preview mandatory-stop behavior and submit the policy
...
Global Application Shell
  -> Multiplayer
  -> Game Speed and Continue Policy
...
- Mandatory decisions cannot be skipped by timing policy
- Timeouts use named policy premises
- The renderer never advances authoritative time independently
- Policy changes cannot affect an already committed simulation step
...
1. Mandatory decisions cannot be skipped by timing policy
2. Timeouts use named policy premises
3. The renderer never advances authoritative time independently
4. Policy changes cannot affect an already committed simulation step
...
```text
Implement Game Speed and Continue Policy for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify game speed and continue policy screen
```
