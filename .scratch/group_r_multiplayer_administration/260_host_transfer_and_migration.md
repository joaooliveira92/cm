# Screen 260: Host Transfer and Migration
...
Host Transfer and Migration moves session coordination authority to an eligible participant or trusted server while preserving career state, locks, timing, participants, and checkpoint integrity.

## 2. Primary user goals

- Review eligible migration targets
- Initiate planned host transfer
- Monitor automatic migration after host loss
- Acknowledge the new authoritative host and resume
...
- Host migration does not transfer club-manager ownership
- The newest verified checkpoint and event tail define recovery state
- Split-brain hosts are prevented through leases or consensus policy
- Migration has bounded timeout and safe failure states
...
1. Host migration does not transfer club-manager ownership
2. The newest verified checkpoint and event tail define recovery state
3. Split-brain hosts are prevented through leases or consensus policy
4. Migration has bounded timeout and safe failure states
...
```text
Implement Host Transfer and Migration for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify host transfer and migration screen
```
