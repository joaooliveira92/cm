# Screen 251: Create Multiplayer Career
...
Create Multiplayer Career configures a networked career with host authority, visibility, invitations, participant limits, manager ownership, timing policy, content compatibility, and save settings.

## 2. Primary user goals

- Choose supported visibility and invitation policy
- Set participant and controlled-manager limits
- Configure continue, pause, checkpoint, and host-migration policies
- Validate content compatibility and create the session
...
- Session secrets are generated in a trusted service
- Participant limits use named policy values
- Creation is idempotent and cannot duplicate a career
- Unsupported content combinations block creation with specific reasons
...
1. Session secrets are generated in a trusted service
2. Participant limits use named policy values
3. Creation is idempotent and cannot duplicate a career
4. Unsupported content combinations block creation with specific reasons
...
```text
Implement Create Multiplayer Career for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify create multiplayer career screen
```
