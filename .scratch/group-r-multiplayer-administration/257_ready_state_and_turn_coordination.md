# Screen 257: Ready State and Turn Coordination
...
Ready State and Turn Coordination shows which participants are ready, blocked, away, disconnected, in a mandatory workflow, or requesting additional time before advancement.

## 2. Primary user goals

- Mark ready or not ready
- Inspect personal and shared blockers
- Request a permitted pause or extension
- Navigate directly to owned mandatory decisions
...
Global Application Shell
  -> Multiplayer
  -> Ready State and Turn Coordination
...
- One participant cannot reveal another manager private blocker details
- Ready state expires when relevant career state changes
- Automatic ready is opt-in and policy-bound
- Advancement requires the authoritative continue policy
...
1. One participant cannot reveal another manager private blocker details
2. Ready state expires when relevant career state changes
3. Automatic ready is opt-in and policy-bound
4. Advancement requires the authoritative continue policy
...
```text
Implement Ready State and Turn Coordination for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify ready state and turn coordination screen
```
