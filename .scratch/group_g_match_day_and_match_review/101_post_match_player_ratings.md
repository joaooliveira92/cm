# Screen 101: Post-Match Player Ratings
...
Post-Match Player Ratings presents finalized ratings, minutes, events, goals, assists, cards, injuries, role, and manager-visible performance notes for every participant.

## 2. Primary user goals

- Sort and filter participants
- Open a player’s match performance detail
- Compare players or units
- Open coach feedback where available
...
```text
+------------------------------------------------------------------------------+
| Final ratings, minutes, role, events, contribution metrics, performance note |
|------------------------------------------------------------------------------|
...
```typescript
interface PostMatchPlayerRatingsModel {
...
- Final ratings use the committed match revision
- Unused substitutes are not assigned played-match ratings
- Dismissed and injured states are explicit
- Performance notes must not reveal hidden formulas
...
1. Final ratings use the committed match revision
2. Unused substitutes are not assigned played-match ratings
3. Dismissed and injured states are explicit
4. Performance notes must not reveal hidden formulas
...
```text
Implement Post-Match Player Ratings for an original football-management simulation. Use one
...
```text
docs(game-ui): specify post match player ratings screen
```
