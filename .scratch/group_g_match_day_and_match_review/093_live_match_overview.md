...
The Live Match Overview is the central match-day dashboard, combining score, clock, match state, key events, formations, momentum-style summaries, tactical alerts, substitutions, and navigation to detailed live views.

## 2. Primary user goals

- Pause or change presentation speed where permitted
- Open commentary, statistics, ratings, tactics, incidents, and match information
- Respond to tactical or injury alerts
- Submit substitutions and tactical changes at valid stoppages
...
```text
+------------------------------------------------------------------------------+
| Scoreboard, clock, current phase, key events, pitch summary, tactical alerts |
|------------------------------------------------------------------------------|
...
```typescript
interface LiveMatchOverviewModel {
...
- The canonical match engine runs outside the renderer
- Presentation speed does not change sporting outcomes
- Score and clock come from committed match events
- Momentum summaries must be labeled as derived presentation
...
1. The canonical match engine runs outside the renderer
2. Presentation speed does not change sporting outcomes
3. Score and clock come from committed match events
4. Momentum summaries must be labeled as derived presentation
...
```text
Implement Live Match Overview for an original football-management simulation. Use one
...
```text
docs(game-ui): specify live match overview screen
```
