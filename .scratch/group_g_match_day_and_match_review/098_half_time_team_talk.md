...
The Half-Time Team Talk lets the manager address the squad and selected players using context-aware, policy-defined messages before the second half.

## 2. Primary user goals

- Review factual first-half context
- Choose one supported team message
- Select optional individual follow-ups
- Preview the addressed audience
- Submit before the half-time deadline
...
```text
+------------------------------------------------------------------------------+
| Half-time score, performance summary, squad mood, team message, individual f |
|------------------------------------------------------------------------------|
...
- Responses are context-aware but uncertain
- The workflow must not generate abusive, humiliating, or threatening content
- Team and individual messages remain distinct
- A missed deadline uses an explicit no-message policy
...
1. Responses are context-aware but uncertain
2. The workflow must not generate abusive, humiliating, or threatening content
3. Team and individual messages remain distinct
4. A missed deadline uses an explicit no-message policy
...
```text
Implement Half-Time Team Talk for an original football-management simulation. Use one
...
```text
docs(game-ui): specify half time team talk screen
```
