# Screen 104: Match Incidents and Disciplinary Review
...
Match Incidents and Disciplinary Review presents cards, fouls, injuries, controversial decisions, appeals, suspensions, and competition follow-up actions after a match.

## 2. Primary user goals

- Filter cards, injuries, goals, substitutions, and reviewable incidents
- Open the incident, player, official, and competition rule
- Start an authorized appeal or disciplinary response
- Review resulting suspension or eligibility impact
...
Global Application Shell
  ...
  -> Match Incidents and Disciplinary Review
...
```text
+------------------------------------------------------------------------------+
| Incident timeline, participants, official decision, evidence summary, bans a |
|------------------------------------------------------------------------------|
...
```typescript
interface MatchIncidentReviewModel {
...
- The screen does not provide real-world legal advice
- Appeal eligibility comes from competition rules
- Incidents and sanctions remain separate canonical records
- Video or visual evidence appears only when the product actually models it
...
1. The screen does not provide real-world legal advice
2. Appeal eligibility comes from competition rules
3. Incidents and sanctions remain separate canonical records
4. Video or visual evidence appears only when the product actually models it
...
```text
Implement Match Incidents and Disciplinary Review for an original football-management simulation. Use one
...
```text
docs(game-ui): specify match incidents and disciplinary review screen
```
