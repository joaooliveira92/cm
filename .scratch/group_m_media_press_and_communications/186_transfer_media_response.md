# Screen 186: Transfer Media Response
...
Transfer Media Response manages public questions and club statements about bids, negotiations, rumours, agreements, failed deals, registrations, and player availability.

## 2. Primary user goals

- Review the public and private boundaries of the transfer state
- Confirm, deny, decline, or provide a policy-supported neutral response
- Open the transfer record, player, club, or negotiation
- Delegate the response to authorized staff
...
```text
+------------------------------------------------------------------------------+
| Transfer topic, public status, confidentiality, rumour confidence, questions |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferMediaResponseDraft {
...
- Private negotiation terms must never be exposed by response options
- Rumour, offer, agreement, completion, and registration remain distinct
- A public statement cannot complete or cancel a transfer
- Responses use the current transfer transaction revision
...
1. Private negotiation terms must never be exposed by response options
2. Rumour, offer, agreement, completion, and registration remain distinct
3. A public statement cannot complete or cancel a transfer
4. Responses use the current transfer transaction revision
...
```text
Implement Transfer Media Response for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer media response screen
```
