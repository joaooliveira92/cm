# Screen 191: Media Relationships
...
Media Relationships summarizes the manager and club’s simulated relationships with journalists and outlets, including familiarity, trust, friction, access, interaction frequency, unresolved issues, and change reasons.

## 2. Primary user goals

- Filter by outlet, journalist, relationship band, and topic
- Open contact profiles and communication history
- Review evidence behind relationship changes
- Create manager-private notes or reminders
...
```text
+------------------------------------------------------------------------------+
| Contacts, relationship bands, access, interaction history, unresolved issues |
|------------------------------------------------------------------------------|
...
```typescript
interface MediaRelationshipsModel {
...
- Relationship bands do not expose hidden exact formulas
- Professional disagreement is not represented as abuse
- Changes reference committed interactions
- Manager and club relationships remain distinct where modeled
...
1. Relationship bands do not expose hidden exact formulas
2. Professional disagreement is not represented as abuse
3. Changes reference committed interactions
4. Manager and club relationships remain distinct where modeled
...
```text
Implement Media Relationships for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify media relationships screen
```
