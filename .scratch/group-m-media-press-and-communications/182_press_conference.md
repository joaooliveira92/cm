...
Press Conference runs a structured multi-question media session with invited outlets, topic context, response options, follow-up questions, deadlines, delegation, and an immutable resulting transcript.

## 2. Primary user goals

- Review the event, participants, and permitted topics
- Choose one supported response to each active question
- Ask for clarification, decline an eligible question, or delegate when permitted
- Review completed answers before ending the conference
...
```text
+------------------------------------------------------------------------------+
| Event, attendees, questions, context, response options, follow-ups, deadline |
|------------------------------------------------------------------------------|
...
```typescript
interface PressConferenceDraft {
...
- Questions and answers must remain professional and nonabusive
- Response options are generated from current career facts and policy
- The manager cannot reveal hidden or unauthorized information through generated choices
- Completed answers become immutable transcript entries
...
1. Questions and answers must remain professional and nonabusive
2. Response options are generated from current career facts and policy
3. The manager cannot reveal hidden or unauthorized information through generated choices
4. Completed answers become immutable transcript entries
...
```text
Implement Press Conference for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify press conference screen
```
