# Screen 187: Player and Staff Public Statement
...
Player and Staff Public Statement presents a public comment made by a player or staff member, its source, topic, reliability, interpretation, club response options, and potential follow-up.

## 2. Primary user goals

- Review the source and reliability of the statement
- Open the person, related event, or contract context
- Respond privately, publicly, delegate, or take no action when supported
- Track the statement within an active narrative
...
Global Application Shell
  ...
  -> Player and Staff Public Statement
...
```text
+------------------------------------------------------------------------------+
| Speaker, role, source, topic, reliability, statement, interpretation, respon |
|------------------------------------------------------------------------------|
...
```typescript
interface PersonPublicStatementModel {
...
- Public reporting and verified direct statements are distinct
- Statements cannot expose hidden personality or private contract data
- Club responses must not be threatening, humiliating, or retaliatory
- The person’s public statement does not itself change contract state
...
1. Public reporting and verified direct statements are distinct
2. Statements cannot expose hidden personality or private contract data
3. Club responses must not be threatening, humiliating, or retaliatory
4. The person’s public statement does not itself change contract state
...
```text
Implement Player and Staff Public Statement for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player and staff public statement screen
```
