# Screen 183: Individual Media Interview
...
Individual Media Interview handles a one-to-one or small-group interview request concerning the manager, club, player, competition, transfer, or career event.

## 2. Primary user goals

- Accept, decline, delegate, or reschedule the request when supported
- Review the journalist, outlet, topic, and publication boundary
- Answer supported questions and follow-ups
- End the interview and review the resulting transcript
...
```text
+------------------------------------------------------------------------------+
| Request, journalist, outlet, topic, format, deadline, privacy, questions, re |
|------------------------------------------------------------------------------|
...
- Declining an optional interview is not the same as refusing a mandatory obligation
- Questions must not solicit private credentials or unnecessary personal data
- Publication timing and embargoes are explicit simulation states
- Interview content remains bound to the selected topic and career facts
...
1. Declining an optional interview is not the same as refusing a mandatory obligation
2. Questions must not solicit private credentials or unnecessary personal data
3. Publication timing and embargoes are explicit simulation states
4. Interview content remains bound to the selected topic and career facts
...
```text
Implement Individual Media Interview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify individual media interview screen
```
