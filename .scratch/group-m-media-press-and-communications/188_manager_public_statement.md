# Screen 188: Manager Public Statement
...
Manager Public Statement lets the user issue a policy-supported statement about a club, player, staff member, fixture, competition, transfer, objective, or personal career topic.

## 2. Primary user goals

- Choose a supported topic and audience
- Review committed facts and privacy boundaries
- Select one policy-defined statement
- Preview linked entities and publication scope
...
```text
+------------------------------------------------------------------------------+
| Topic, audience, factual context, tone, statement choices, publication timin |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerPublicStatementDraft {
...
- Free-form publication is replaced by constrained safe statement structures
- Statements may influence simulated relationships but outcomes are uncertain
- The workflow cannot target protected identities with degrading content
- Publication does not mutate unrelated canonical records
...
1. Free-form publication is replaced by constrained safe statement structures
2. Statements may influence simulated relationships but outcomes are uncertain
3. The workflow cannot target protected identities with degrading content
4. Publication does not mutate unrelated canonical records
...
```text
Implement Manager Public Statement for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager public statement screen
```
