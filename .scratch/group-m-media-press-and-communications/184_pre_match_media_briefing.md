# Screen 184: Pre-Match Media Briefing
...
Pre-Match Media Briefing lets the manager address expected selection, tactics, opposition, availability, form, pressure, objectives, and supporter expectations before a fixture.

## 2. Primary user goals

- Review fixture facts and permitted talking points
- Respond to questions concerning preparation and expectations
- Avoid or delegate sensitive topics when policy allows
- Submit the briefing before the authoritative deadline
...
```text
+------------------------------------------------------------------------------+
| Fixture, opposition, form, availability, expectations, questions, talking po |
|------------------------------------------------------------------------------|
...
- The briefing must not reveal the unannounced lineup or private tactic accidentally
- Opposition claims must respect scouting knowledge and uncertainty
- Fitness and medical details follow privacy policy
- Statements do not modify match preparation directly
...
1. The briefing must not reveal the unannounced lineup or private tactic accidentally
2. Opposition claims must respect scouting knowledge and uncertainty
3. Fitness and medical details follow privacy policy
4. Statements do not modify match preparation directly
...
```text
Implement Pre-Match Media Briefing for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify pre match media briefing screen
```
