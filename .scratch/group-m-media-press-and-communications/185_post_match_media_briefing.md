# Screen 185: Post-Match Media Briefing
...
Post-Match Media Briefing addresses the final result, performance, incidents, officials, players, tactics, expectations, and next steps after a committed match.

## 2. Primary user goals

- Review committed match facts before responding
- Answer supported questions about performance and decisions
- Open incidents, statistics, ratings, or the match report
- Complete or delegate the briefing
...
```text
+------------------------------------------------------------------------------+
| Result, performance, incidents, expectations, player topics, official decisi |
|------------------------------------------------------------------------------|
...
- The match result and incidents must be committed before the briefing
- Statements about officials remain professional and policy-constrained
- Generated answers cannot invent events or private dressing-room information
- The briefing cannot alter the match result or disciplinary record
...
1. The match result and incidents must be committed before the briefing
2. Statements about officials remain professional and policy-constrained
3. Generated answers cannot invent events or private dressing-room information
4. The briefing cannot alter the match result or disciplinary record
...
```text
Implement Post-Match Media Briefing for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify post match media briefing screen
```
