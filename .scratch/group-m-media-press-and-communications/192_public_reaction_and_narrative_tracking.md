# Screen 192: Public Reaction and Narrative Tracking
...
Public Reaction and Narrative Tracking follows how supporters, board members, players, staff, media, and the wider football world respond to published events and how active narratives evolve over time.

## 2. Primary user goals

- Open an active narrative and its evidence timeline
- Filter by audience, topic, club, person, competition, and status
- Review how statements and events contributed to change
- Open related media, supporter, board, or player views
...
```text
+------------------------------------------------------------------------------+
| Narratives, audiences, sentiment bands, reach, evidence, timeline, related e |
|------------------------------------------------------------------------------|
...
```typescript
interface PublicNarrativeModel {
...
- Audience sentiment is aggregated and must not stereotype groups
- Narrative influence is uncertain and multifactorial
- Private manager information is excluded from public narratives
- Sentiment bands require textual definitions and evidence
...
1. Audience sentiment is aggregated and must not stereotype groups
2. Narrative influence is uncertain and multifactorial
3. Private manager information is excluded from public narratives
4. Sentiment bands require textual definitions and evidence
...
```text
Implement Public Reaction and Narrative Tracking for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify public reaction and narrative tracking screen
```
