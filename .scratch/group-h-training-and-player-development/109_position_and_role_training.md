# Screen 109: Position and Role Training
...
Position and Role Training assigns a valid positional zone, tactical role, duty, and familiarity target for an individual player without changing match selection automatically.

## 2. Primary user goals

- Choose a supported target position
- Choose compatible role and duty
- Review current familiarity and estimated adaptation
- Clear or replace the current target
- Submit one individual development target
...
```text
+------------------------------------------------------------------------------+
| Current positions, target position, role, duty, familiarity, estimated adapt |
|------------------------------------------------------------------------------|
...
```typescript
interface PositionRoleTrainingDraft {
...
- Position familiarity and role suitability remain separate
- Adaptation forecasts are estimates
- Unsupported or age-restricted targets are rejected by policy
- Completing training never forces tactical assignment
...
1. Position familiarity and role suitability remain separate
2. Adaptation forecasts are estimates
3. Unsupported or age-restricted targets are rejected by policy
4. Completing training never forces tactical assignment
...
```text
Implement Position and Role Training for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify position and role training screen
```
