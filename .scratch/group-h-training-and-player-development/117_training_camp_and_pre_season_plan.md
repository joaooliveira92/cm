# Screen 117: Training Camp and Pre-Season Plan
...
Training Camp and Pre-Season Plan configures dates, location, travel, invited players, friendlies, workload phases, recovery, objectives, costs, and cancellation rules for a pre-season or midseason camp.

## 2. Primary user goals

- Choose an available camp window and location
- Select eligible travelling players and staff
- Configure workload phases and friendlies
- Review cost, travel, recovery, and fixture conflicts
- Submit or cancel the camp plan through an authoritative transaction
...
```text
+------------------------------------------------------------------------------+
| Camp dates, location, squad, schedule, friendlies, objectives, facilities, c |
|------------------------------------------------------------------------------|
...
```typescript
interface TrainingCampPlanDraft {
...
- Locations and facilities use approved database entities
- Costs use explicit currency and budget authority
- Camp benefits are probabilistic, not guaranteed
- Travel, visas, fixture dates, and player availability are revalidated at submission
...
1. Locations and facilities use approved database entities
2. Costs use explicit currency and budget authority
3. Camp benefits are probabilistic, not guaranteed
4. Travel, visas, fixture dates, and player availability are revalidated at submission
...
```text
Implement Training Camp and Pre-Season Plan for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify training camp and pre season plan screen
```
