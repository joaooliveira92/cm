# Screen 111: Coaching Assignments
...
Coaching Assignments allocates coaches to training categories and units while showing qualifications, workload, coverage, quality, conflicts, and staffing gaps.

## 2. Primary user goals

- Assign or remove coaches from categories
- Review eligible-coach evidence
- Apply a deterministic previewable recommendation
- Balance workloads
- Save the coaching assignment revision
...
```text
+------------------------------------------------------------------------------+
| Training categories, assigned coaches, workload, coverage quality, qualifica |
|------------------------------------------------------------------------------|
...
```typescript
interface CoachingAssignmentDraft {
...
- Coach workload and category coverage are separate
- One coach may cover several categories within policy capacity
- Recommendation quality respects manager knowledge
- Assignments do not alter staff contracts or delegated authority
...
1. Coach workload and category coverage are separate
2. One coach may cover several categories within policy capacity
3. Recommendation quality respects manager knowledge
4. Assignments do not alter staff contracts or delegated authority
...
```text
Implement Coaching Assignments for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify coaching assignments screen
```
