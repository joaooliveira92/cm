...
Mentoring Groups creates and manages small player groups intended to support adaptation, professionalism, leadership, social integration, and football-specific learning.

## 2. Primary user goals

- Create, rename, or dissolve a group
- Assign eligible mentors and participants
- Review compatibility and communication concerns
- Move players between groups
- Save one validated mentoring revision
...
```text
+------------------------------------------------------------------------------+
| Groups, mentors, participants, influence, compatibility, language, schedule  |
|------------------------------------------------------------------------------|
...
- Mentoring effects are gradual and uncertain
- Private personality observations follow permission policy
- A player cannot occupy incompatible simultaneous groups
- Group names and notes are untrusted manager content
...
1. Mentoring effects are gradual and uncertain
2. Private personality observations follow permission policy
3. A player cannot occupy incompatible simultaneous groups
4. Group names and notes are untrusted manager content
...
```text
Implement Mentoring Groups for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify mentoring groups screen
```
