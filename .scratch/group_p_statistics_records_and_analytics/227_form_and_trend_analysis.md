# Screen 227: Form and Trend Analysis
...
Form and Trend Analysis tracks rolling results and performance indicators for clubs, teams, units, and players while distinguishing short-term variation from longer-term movement.

## 2. Primary user goals

- Select entity, metric, period, and rolling-window profile
- Compare recent and baseline periods
- Inspect supporting observations
- Save alerts for meaningful changes
...
- Rolling windows use named premise profiles
- Missing observations are not interpolated silently
- Trend labels include uncertainty and sample size
- Form is descriptive rather than destiny
...
1. Rolling windows use named premise profiles
2. Missing observations are not interpolated silently
3. Trend labels include uncertainty and sample size
4. Form is descriptive rather than destiny
...
```text
Implement Form and Trend Analysis for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify form and trend analysis screen
```
