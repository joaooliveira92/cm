...
Tactical Analysis evaluates formation use, role behavior, instruction outcomes, phase patterns, spatial tendencies, combinations, vulnerabilities, and tactical changes across matches.

## 2. Primary user goals

- Choose tactic, match set, phase, and pattern category
- Inspect formation and instruction revisions
- Open supporting matches and events
- Compare tactical variants
...
- Observed outcomes do not guarantee future performance
- Tactical analysis must not expose hidden opposition instructions
- Changes are aligned to their effective match boundaries
- Spatial summaries disclose model resolution
...
1. Observed outcomes do not guarantee future performance
2. Tactical analysis must not expose hidden opposition instructions
3. Changes are aligned to their effective match boundaries
4. Spatial summaries disclose model resolution
...
```text
Implement Tactical Analysis for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify tactical analysis screen
```
