...
The Analytics Centre is the landing page for team, player, match, tactical, recruitment, squad, financial, historical, and records analysis. It summarizes available coverage, recent insights, saved reports, data freshness, and actionable warnings.

## 2. Primary user goals

- Open any supported analytics workspace
- Review recent insights and changed metrics
- Open saved, scheduled, and shared reports
- Inspect data coverage and freshness
...
- Every insight identifies its scope, period, definition, and coverage
- The centre must not imply causation from correlation
- Knowledge and permission rules apply to person-level data
- The dashboard does not mutate canonical football state
...
1. Every insight identifies its scope, period, definition, and coverage
2. The centre must not imply causation from correlation
3. Knowledge and permission rules apply to person-level data
4. The dashboard does not mutate canonical football state
...
```text
Implement Analytics Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify analytics centre screen
```
