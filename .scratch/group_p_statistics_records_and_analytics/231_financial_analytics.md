# Screen 231: Financial Analytics
...
Financial Analytics presents income, expenses, wages, transfers, installments, clauses, cash flow, budgets, projections, scenarios, and financial-risk indicators.

## 2. Primary user goals

- Choose period, ledger category, competition, and scenario
- Inspect transactions and assumptions
- Compare actual, budget, and projected values
- Export a permission-safe financial report
...
- Projections are estimates with named assumptions
- Contingent transfer costs remain separate from guaranteed costs
- Exact financial data is permission-restricted
...
2. Projections are estimates with named assumptions
3. Contingent transfer costs remain separate from guaranteed costs
4. Exact financial data is permission-restricted
...
```text
Implement Financial Analytics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify financial analytics screen
```
