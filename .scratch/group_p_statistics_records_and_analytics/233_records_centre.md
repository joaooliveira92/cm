...
Records Centre consolidates career, world, nation, competition, club, team, player, manager, match, transfer, attendance, and financial records.

## 2. Primary user goals

- Browse record categories and scopes
- Open record holder and supporting event
- Review tied, superseded, and corrected records
- Compare current and historical editions
...
- Records use normalized definitions
- Ties and coverage limits are explicit
- The renderer never declares an official record
...
1. Records use normalized definitions
2. Ties and coverage limits are explicit
3. The renderer never declares an official record
4. Corrections preserve an audit trail
...
```text
Implement Records Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify records centre screen
```
