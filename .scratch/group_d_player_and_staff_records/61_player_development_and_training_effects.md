# Screen 61: Player Development and Training Effects
...
Player Development and Training Effects presents observed attribute trends, training participation, coach assessment, workload, role progress, and developmental milestones over time.

## 2. Primary user goals

- Change the observation period
- Open training schedule and coach report
- Review role or position familiarity progress
- Compare development with another player
...
Global Application Shell
  ...
  -> Player Development and Training Effects
...
```text
| PLAYER > DEVELOPMENT | Last 6 months |
| Tactical +1 | Physical stable | Technical +2 |
| Training workload: Medium | Progress: Improving |
| Coach assessment, role familiarity, milestones |
```
...
interface PlayerDevelopmentModel {
  ...
  readonly period: DevelopmentPeriod;
  readonly observedChanges: readonly DevelopmentChange[];
  readonly trainingSummary: PlayerTrainingSummary;
  readonly coachAssessments: readonly CoachAssessmentSummary[];
  readonly milestones: readonly DevelopmentMilestone[];
...
- Observed effects must not reveal hidden exact potential
- Correlation with training is not guaranteed causation
- Injury, match exposure, age, morale, and coaching context may affect interpretation
- Change arrows require text equivalents
...
1. Observed effects must not reveal hidden exact potential
2. Correlation with training is not guaranteed causation
3. Injury, match exposure, age, morale, and coaching context may affect interpretation
4. Change arrows require text equivalents
...
```text
Implement Player Development and Training Effects for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player development and training effects screen
```
