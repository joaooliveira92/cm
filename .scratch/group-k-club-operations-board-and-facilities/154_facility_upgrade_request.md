# Screen 154: Facility Upgrade Request
...
Facility Upgrade Request creates and tracks proposals for training, youth, medical, recruitment, analysis, or other club facilities with cost, duration, capacity, disruption, and board conditions.

## 2. Primary user goals

- Choose an eligible facility upgrade
- Review cost, schedule, benefit assumptions, and disruption
- Select supported timing or phasing options
- Submit, revise, or cancel the proposal
...
```text
+------------------------------------------------------------------------------+
| Facility target, current level, proposed level, cost, duration, disruption,  |
|------------------------------------------------------------------------------|
...
```typescript
interface FacilityUpgradeRequestDraft {
...
- Facility benefits are probabilistic or qualitative, not guaranteed
- Costs use explicit currency and cash-flow dates
- Only one incompatible project may occupy a facility at a time
- Construction state updates atomically
...
1. Facility benefits are probabilistic or qualitative, not guaranteed
2. Costs use explicit currency and cash-flow dates
3. Only one incompatible project may occupy a facility at a time
4. Construction state updates atomically
...
```text
Implement Facility Upgrade Request for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify facility upgrade request screen
```
