# Screen 150: Board Response and Negotiation
...
Board Response and Negotiation presents the board decision, conditions, alternatives, follow-up questions, deadlines, and permitted manager responses for an active request.

## 2. Primary user goals

- Review the decision and supporting reasons
- Accept conditions, revise the request, defer, or withdraw
- Compare the response with the original request
- Open related finance, facility, or staffing context
...
```text
+------------------------------------------------------------------------------+
| Decision, reasons, conditions, alternatives, deadline, history, response opt |
|------------------------------------------------------------------------------|
...
- Board responses create immutable revisions
- Only current supported response options can be submitted
- Conditions are explicit and measurable
- Expired responses become read-only
...
1. Board responses create immutable revisions
2. Only current supported response options can be submitted
3. Conditions are explicit and measurable
4. Expired responses become read-only
...
```text
Implement Board Response and Negotiation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify board response and negotiation screen
```
