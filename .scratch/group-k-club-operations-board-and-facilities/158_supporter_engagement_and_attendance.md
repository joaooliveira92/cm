# Screen 158: Supporter Engagement and Attendance
...
Supporter Engagement and Attendance presents attendance, capacity usage, season-ticket demand, supporter sentiment, match categories, pricing context where modeled, initiatives, and accessibility of club events.

## 2. Primary user goals

- Review attendance and demand trends
- Filter by competition, opponent category, and period
- Open supporter initiatives and board context
- Compare attendance with capacity and prior seasons
...
```text
+------------------------------------------------------------------------------+
| Attendance, capacity, demand, sentiment, initiatives, match categories, tren |
|------------------------------------------------------------------------------|
...
```typescript
interface SupporterEngagementModel {
...
- Supporter groups must not be portrayed through harmful stereotypes
- Attendance forecasts are estimates
- Ticket pricing actions appear only when the simulation supports them
- Personal supporter data is not exposed
...
1. Supporter groups must not be portrayed through harmful stereotypes
2. Attendance forecasts are estimates
3. Ticket pricing actions appear only when the simulation supports them
4. Personal supporter data is not exposed
...
```text
Implement Supporter Engagement and Attendance for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify supporter engagement and attendance screen
```
