# Screen 153: Club Policy and Delegation
...
Club Policy and Delegation configures manager-authorized policies for transfers, contracts, scouting, training, youth, media, and staff workflows without changing competition rules.

## 2. Primary user goals

- Review policy areas and current authority
- Set supported delegation levels
- Configure approval or notification thresholds
- Restore board or manager defaults
- Submit a validated policy revision
...
```text
+------------------------------------------------------------------------------+
| Policy areas, authority levels, approval thresholds, delegated staff, except |
|------------------------------------------------------------------------------|
...
```typescript
interface ClubDelegationPolicyDraft {
...
- Competition and legal simulation rules cannot be overridden
- Threshold premises come from named policy values
- Delegation never grants more authority than the club owns
- Financial thresholds use explicit currency
...
1. Competition and legal simulation rules cannot be overridden
2. Threshold premises come from named policy values
3. Delegation never grants more authority than the club owns
4. Financial thresholds use explicit currency
...
```text
Implement Club Policy and Delegation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club policy and delegation screen
```
