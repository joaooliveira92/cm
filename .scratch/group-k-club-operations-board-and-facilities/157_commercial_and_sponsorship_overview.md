# Screen 157: Commercial and Sponsorship Overview
...
Commercial and Sponsorship Overview presents commercial income, sponsorship agreements, merchandising, hospitality, broadcasts, partnerships, renewals, projections, and board-visible opportunities.

## 2. Primary user goals

- Review current agreements and income categories
- Inspect renewal and expiry dates
- Open board-approved commercial opportunities
- Compare actual and projected revenue
- Navigate to the financial ledger
...
```text
+------------------------------------------------------------------------------+
| Sponsors, commercial income, agreements, renewals, projections, opportunitie |
|------------------------------------------------------------------------------|
...
```typescript
interface CommercialOverviewModel {
...
- Commercial terms obey visibility policy
- Projected revenue is not guaranteed
- The manager cannot negotiate unsupported commercial contracts directly
...
1. Commercial terms obey visibility policy
2. Projected revenue is not guaranteed
3. The manager cannot negotiate unsupported commercial contracts directly
4. Money uses explicit currency and period
...
```text
Implement Commercial and Sponsorship Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify commercial and sponsorship overview screen
```
