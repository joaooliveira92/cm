# Screen 155: Stadium Expansion and Relocation
...
Stadium Expansion and Relocation manages feasibility studies, expansion proposals, temporary venues, planning stages, financing, capacity, ownership, and relocation projects.

## 2. Primary user goals

- Request a feasibility study
- Review expansion or relocation alternatives
- Select a valid temporary venue where needed
- Review financing, attendance assumptions, and schedule
- Submit the project for board approval
...
```text
+------------------------------------------------------------------------------+
| Current stadium, proposal, capacity, ownership, temporary venue, financing,  |
|------------------------------------------------------------------------------|
...
- Stadium ownership and operating rights remain distinct
- Venue availability and competition standards are authoritative
- Projects require phased transactional state
...
1. Attendance forecasts are estimates
2. Stadium ownership and operating rights remain distinct
3. Venue availability and competition standards are authoritative
4. Projects require phased transactional state
...
```text
Implement Stadium Expansion and Relocation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify stadium expansion and relocation screen
```
