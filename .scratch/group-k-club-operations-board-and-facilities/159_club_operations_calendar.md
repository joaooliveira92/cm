# Screen 159: Club Operations Calendar
...
Club Operations Calendar combines board meetings, project milestones, sponsorship renewals, contract options, registration windows, facility work, affiliate reviews, and operational deadlines.

## 2. Primary user goals

- Switch month, week, agenda, and project views
- Filter operational categories
- Open linked request, project, contract, or meeting
- Create manager-private reminders
- Navigate to a future date without skipping mandatory decisions
...
```text
+------------------------------------------------------------------------------+
| Meetings, projects, renewals, options, windows, deadlines, reminders         |
|------------------------------------------------------------------------------|
...
```typescript
interface ClubOperationsCalendarModel {
...
- Authoritative events and private reminders remain distinct
- Deadline dates come from current transaction revisions
- Filters never delete hidden events
- Date advancement routes through Continue validation
...
1. Authoritative events and private reminders remain distinct
2. Deadline dates come from current transaction revisions
3. Filters never delete hidden events
4. Date advancement routes through Continue validation
...
```text
Implement Club Operations Calendar for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club operations calendar screen
```
