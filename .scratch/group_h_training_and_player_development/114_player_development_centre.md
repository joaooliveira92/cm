# Screen 114: Player Development Centre
...
The Player Development Centre consolidates individual plans, coach reports, position training, trait work, mentoring, loan-development status, youth pathways, and development priorities for the club.

## 2. Primary user goals

- Filter players by squad, age, pathway, concern, and plan state
- Open individual training, reports, mentoring, loan, or promotion workflows
- Assign development priority
- Review milestones and stalled plans
- Compare development across periods
...
```text
+------------------------------------------------------------------------------+
| Development list, pathways, plans, reports, mentoring, loans, milestones and |
|------------------------------------------------------------------------------|
...
```typescript
interface PlayerDevelopmentCentreModel {
...
- Development priority is a planning label, not a hidden ability boost
- Potential remains uncertain and knowledge-limited
- Loan development and club training use separate evidence
- Bulk operations preview all affected players
...
1. Development priority is a planning label, not a hidden ability boost
2. Potential remains uncertain and knowledge-limited
3. Loan development and club training use separate evidence
4. Bulk operations preview all affected players
...
```text
Implement Player Development Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player development centre screen
```
