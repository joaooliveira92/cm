# Screen 112: Training Workload and Recovery
...
Training Workload and Recovery presents team and player workload, fatigue, recovery, rest recommendations, medical restrictions, fixture congestion, and safe intensity adjustments.

## 2. Primary user goals

- Filter players by workload or recovery concern
- Open medical or individual-plan details
- Reduce or restore training intensity
- Schedule permitted rest or recovery sessions
- Review future congestion
...
```text
+------------------------------------------------------------------------------+
| Team workload, player fatigue, recovery state, congestion calendar, risk ban |
|------------------------------------------------------------------------------|
...
```typescript
interface TrainingRecoveryModel {
...
- Risk bands are simulations, not real medical advice
- Health data is sensitive and permission-restricted
- Medical restrictions override general recommendations
- Workload changes require a new training revision
...
1. Risk bands are simulations, not real medical advice
2. Health data is sensitive and permission-restricted
3. Medical restrictions override general recommendations
4. Workload changes require a new training revision
...
```text
Implement Training Workload and Recovery for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify training workload and recovery screen
```
