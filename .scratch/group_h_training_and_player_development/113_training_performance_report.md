# Screen 113: Training Performance Report
...
Training Performance Report summarizes recent attendance, coach ratings, unit progress, player development observations, workload response, tactical familiarity, and unresolved training issues.

## 2. Primary user goals

- Change the report period and squad scope
- Open a player, coach, unit, session, or development event
- Compare current and prior reports
- Create notebook notes or follow-up actions
- Export a privacy-safe report summary
...
```text
+------------------------------------------------------------------------------+
| Reporting period, attendance, unit ratings, player observations, familiarity |
|------------------------------------------------------------------------------|
...
```typescript
interface TrainingPerformanceReportModel {
...
- Coach comments are knowledge-limited observations
- Reported improvement does not prove one session caused it
- Missing detail remains unavailable
- Report prose must not expose hidden exact potential
...
1. Coach comments are knowledge-limited observations
2. Reported improvement does not prove one session caused it
3. Missing detail remains unavailable
4. Report prose must not expose hidden exact potential
...
```text
Implement Training Performance Report for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify training performance report screen
```
