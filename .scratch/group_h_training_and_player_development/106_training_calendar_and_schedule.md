# Screen 106: Training Calendar and Schedule
...
Training Calendar and Schedule builds the team-level session plan across days and weeks, including tactical preparation, technical work, physical work, recovery, rest, travel, matches, and special events.

## 2. Primary user goals

- Add, move, duplicate, replace, or remove a supported session
- Apply a named schedule template
- Review workload and recovery implications
- Copy a week or microcycle
- Validate and save one schedule revision
...
```text
+------------------------------------------------------------------------------+
| Weekly calendar, session slots, match and travel context, intensity, conflic |
|------------------------------------------------------------------------------|
...
```typescript
interface TrainingScheduleDraft {
...
- Matches, travel, rest, and mandatory events cannot be overwritten by ordinary sessions
- Session capacity and timing come from policy
- Changing the schedule previews workload and familiarity impact
- Drag operations require keyboard and menu alternatives
...
1. Matches, travel, rest, and mandatory events cannot be overwritten by ordinary sessions
2. Session capacity and timing come from policy
3. Changing the schedule previews workload and familiarity impact
4. Drag operations require keyboard and menu alternatives
...
```text
Implement Training Calendar and Schedule for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify training calendar and schedule screen
```
