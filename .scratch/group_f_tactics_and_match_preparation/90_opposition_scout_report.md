# Screen 90: Opposition Scout Report
...
Opposition Scout Report provides a fixture-specific, knowledge-limited assessment of the next opponent, including likely lineup, formation, tactical tendencies, key threats, weaknesses, set pieces, availability, and report confidence.

## 2. Primary user goals

- Review prediction confidence and freshness
- Open visible opponent player profiles
- Inspect tactical and set-piece findings
- Compare current and previous opposition reports
- Assign additional scouting when time and authority permit
...
```text
+------------------------------------------------------------------------------+
| OPPOSITION REPORT: EXAMPLE CITY                    Updated 14 February        |
|------------------------------------------------------------------------------|
| Likely formation 4-2-3-1 | Confidence Good | Scout Jamie Observer            |
| Key threats: Wide forward, attacking midfielder                              |
| Likely weaknesses: Space behind full-backs                                    |
| Set pieces: Strong near-post corners                                           |
| Predicted lineup and availability with uncertainty                             |
|------------------------------------------------------------------------------|
| [Squad View] [Tactical Tendencies] [Previous Reports] [Assign Scout] [Back]   |
+------------------------------------------------------------------------------+
```
...
```typescript
interface OppositionScoutReportModel {
  ...
  readonly predictedLineup: readonly PredictedPlayerAssignment[];
  readonly tendencies: readonly TacticalFinding[];
  readonly threats: readonly ScoutingFinding[];
...
- Predicted lineup and shape are uncertain, not authoritative opposition data
- Unavailable or hidden players must not leak through ordering or prose
- Findings reflect scout capability, observation coverage, and date
- The report cannot modify the user’s tactic directly without an explicit reviewed action
...
1. Predicted lineup and shape are uncertain, not authoritative opposition data
2. Unavailable or hidden players must not leak through ordering or prose
3. Findings reflect scout capability, observation coverage, and date
4. The report cannot modify the user’s tactic directly without an explicit reviewed action
...
```text
Implement Opposition Scout Report for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify opposition scout report screen
```
