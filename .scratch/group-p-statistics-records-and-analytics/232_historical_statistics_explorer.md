# Screen 232: Historical Statistics Explorer
...
Historical Statistics Explorer queries seasons, competitions, clubs, teams, players, managers, matches, transfers, and awards across the loaded career history.

## 2. Primary user goals

- Build a bounded historical query
- Choose dimensions, measures, filters, and periods
- Inspect source coverage and definitions
- Save or export a permitted result
...
- Queries are bounded and cancellable
- Entity renames preserve stable historical identity
- Cross-era comparisons disclose rule and coverage changes
...
1. Historical gaps remain explicit
2. Queries are bounded and cancellable
3. Entity renames preserve stable historical identity
4. Cross-era comparisons disclose rule and coverage changes
...
```text
Implement Historical Statistics Explorer for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify historical statistics explorer screen
```
