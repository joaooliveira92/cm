# Screen 229: Squad Depth and Availability Analysis
...
Squad Depth and Availability Analysis evaluates role coverage, position depth, age, contracts, registration, injuries, suspensions, workload, development pathways, and future squad scenarios.

## 2. Primary user goals

- Choose current or future planning date
- Inspect role and position coverage
- Open players, eligibility, contracts, and planner scenarios
- Create recruitment or development follow-ups
...
Global Application Shell
  ...
  -> Squad Depth and Availability Analysis
...
- Scenario assumptions are explicit and noncanonical
- Availability, registration, and suitability remain separate
- Unconfirmed arrivals and departures are provisional
- Private health and contract information follows permissions
...
1. Scenario assumptions are explicit and noncanonical
2. Availability, registration, and suitability remain separate
3. Unconfirmed arrivals and departures are provisional
4. Private health and contract information follows permissions
...
```text
Implement Squad Depth and Availability Analysis for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify squad depth and availability analysis screen
```
