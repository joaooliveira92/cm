# Screen 228: Expected Performance and Chance Quality
...
Expected Performance and Chance Quality presents model-based estimates for scoring, conceding, chance difficulty, finishing, prevention, and result likelihood where supported by the simulation.

## 2. Primary user goals

- Choose model version, competition, period, and entity
- Inspect estimate definitions and calibration notes
- Open supporting events
...
Global Application Shell
  ...
  -> Expected Performance and Chance Quality
...
- Expected metrics are estimates, not facts or guarantees
- Model version and input coverage are visible
- No unsupported real-world model claims are made
- Probability displays are bounded and accessible
...
1. Expected metrics are estimates, not facts or guarantees
2. Model version and input coverage are visible
3. No unsupported real-world model claims are made
4. Probability displays are bounded and accessible
...
```text
Implement Expected Performance and Chance Quality for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify expected performance and chance quality screen
```
