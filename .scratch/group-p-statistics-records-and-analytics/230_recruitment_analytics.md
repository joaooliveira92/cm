# Screen 230: Recruitment Analytics
...
Recruitment Analytics compares visible candidates using performance, role fit, age, availability, value, wage, adaptation, risk, scouting confidence, and club strategy.

## 2. Primary user goals

- Choose candidate set and recruitment profile
- Inspect metric evidence and confidence
- Compare raw, normalized, and contextual values
- Open scouting, shortlist, or transfer workflows
...
- Analytics cannot reveal hidden exact player data
- Ranking weights use named profiles and remain explainable
- Unknown values do not reduce to zero
- Recommendation is advisory and context-dependent
...
1. Analytics cannot reveal hidden exact player data
2. Ranking weights use named profiles and remain explainable
3. Unknown values do not reduce to zero
4. Recommendation is advisory and context-dependent
...
```text
Implement Recruitment Analytics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify recruitment analytics screen
```
