# Screen 211: Call-Up and Standby List
...
Manages formal call-ups, standby selections, replacements, response status, travel instructions, reporting dates, and acknowledgement state.

## 2. Primary user goals

- Issue or withdraw supported call-ups
- Move players between selected and standby lists
- Review response, travel, and reporting status
- Replace unavailable players before the deadline
...
- A call-up does not guarantee arrival or match participation
- Selected and standby status are distinct
- Messages use constrained professional templates
- Withdrawal and replacement preserve audit history
...
1. A call-up does not guarantee arrival or match participation
2. Selected and standby status are distinct
3. Messages use constrained professional templates
4. Withdrawal and replacement preserve audit history
...
```text
Implement Call-Up and Standby List for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify call up and standby list screen
```
