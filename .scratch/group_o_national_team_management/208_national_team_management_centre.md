# Screen 208: National Team Management Centre
...
Central dashboard for the controlled national team, combining squad deadlines, eligibility issues, fixtures, campaign position, staff, tactics, scouting, player availability, and federation objectives.

## 2. Primary user goals

- Open squad selection, tactics, staff, campaign, fixtures, and eligibility
- Review upcoming deadlines and unresolved alerts
- Switch among senior and supported youth teams
- Open federation objectives and confidence
...
- National-team and club authority remain separate
- Dashboard data uses one coherent international-management revision
- Alerts link to authoritative corrective workflows
- Private selections remain hidden until their release boundary
...
1. National-team and club authority remain separate
2. Dashboard data uses one coherent international-management revision
3. Alerts link to authoritative corrective workflows
4. Private selections remain hidden until their release boundary
...
```text
Implement National Team Management Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify national team management centre screen
```
