# Screen 209: International Squad Selection
...
Selects a national-team squad for an international window, friendly series, qualifying round, or tournament from eligible and available players.

## 2. Primary user goals

- Search and filter eligible players
- Add, remove, replace, and reorder selected players
- Review positional balance, caps, form, fitness, and release concerns
- Submit the squad before the authoritative deadline
...
- Eligibility, availability, call-up, arrival, registration, and match selection are distinct
- Squad limits come from the active event rules
- Duplicate players are impossible
- Submission is atomic and revision-bound
...
1. Eligibility, availability, call-up, arrival, registration, and match selection are distinct
2. Squad limits come from the active event rules
3. Duplicate players are impossible
4. Submission is atomic and revision-bound
...
```text
Implement International Squad Selection for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international squad selection screen
```
