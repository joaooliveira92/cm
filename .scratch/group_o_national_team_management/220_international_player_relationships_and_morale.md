# Screen 220: International Player Relationships and Morale
...
Presents squad morale, cohesion, leadership, relationships, adaptation, playing-time concerns, and international-team promises during a call-up window.

## 2. Primary user goals

- Review squad and individual concerns
- Open supported player interactions
- Review leadership and mentoring context
...
Global Application Shell
  -> National Team
  -> International Player Relationships and Morale
...
- International and club morale contexts remain distinct
- Private relationship details are permission-restricted
- No hidden numeric morale formula is exposed
- Interactions remain professional and nonabusive
...
1. International and club morale contexts remain distinct
2. Private relationship details are permission-restricted
3. No hidden numeric morale formula is exposed
4. Interactions remain professional and nonabusive
...
```text
Implement International Player Relationships and Morale for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international player relationships and morale screen
```
