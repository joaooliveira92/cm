...
| Content pack provenance in generated saves | **Content Pack** | note `2026-09-05-saves-generated-under-the-worlds-content-pack` (`implemented/architecture/`) | `club-selection/` | `packages/shared/test/contentPack.test.ts` (`contentPackForWorld`), `apps/desktop/test/main/world/display-names.test.ts` (Série A save records the licensed pack and resolves "Flamengo") |
