...
export const CITIES_BY_NATION: Readonly<Record<NationCode, readonly City[]>> = {
  ENG: [
    ...
    { nationCode: "ENG", name: "Newcastle", populationBand: "large" },
    { nationCode: "ENG", name: "Brighton", populationBand: "large" },
    { nationCode: "ENG", name: "Sunderland", populationBand: "large" },
    ...
    { nationCode: "ENG", name: "Bournemouth", populationBand: "mid" },
    { nationCode: "ENG", name: "Wolverhampton", populationBand: "mid" },
    { nationCode: "ENG", name: "Luton", populationBand: "small" },
    { nationCode: "ENG", name: "Burnley", populationBand: "small" },
  ],
  ESP: [
    ...
    { nationCode: "ESP", name: "Vigo", populationBand: "mid" },
    { nationCode: "ESP", name: "Elche", populationBand: "mid" },
    ...
    { nationCode: "ESP", name: "Vitoria-Gasteiz", populationBand: "mid" },
    { nationCode: "ESP", name: "Pamplona", populationBand: "mid" },
    { nationCode: "ESP", name: "A Coruna", populationBand: "mid" },
    { nationCode: "ESP", name: "San Sebastian", populationBand: "small" },
    { nationCode: "ESP", name: "Getafe", populationBand: "small" },
    { nationCode: "ESP", name: "Santander", populationBand: "small" },
    { nationCode: "ESP", name: "Villarreal", populationBand: "small" },
    { nationCode: "ESP", name: "Cornella de Llobregat", populationBand: "small" },
  ...
  PRT: [
    ...
    { nationCode: "PRT", name: "Alverca", populationBand: "small" },
    { nationCode: "PRT", name: "Amadora", populationBand: "large" },
    { nationCode: "PRT", name: "Arouca", populationBand: "small" },
    { nationCode: "PRT", name: "Coimbra", populationBand: "mid" },
    { nationCode: "PRT", name: "Faro", populationBand: "mid" },
    { nationCode: "PRT", name: "Guimarães", populationBand: "mid" },
    { nationCode: "PRT", name: "Ponta Delgada", populationBand: "mid" },
    { nationCode: "PRT", name: "Setubal", populationBand: "mid" },
    { nationCode: "PRT", name: "Barcelos", populationBand: "small" },
    { nationCode: "PRT", name: "Estoril", populationBand: "small" },
    { nationCode: "PRT", name: "Funchal", populationBand: "small" },
    { nationCode: "PRT", name: "Portimao", populationBand: "small" },
    { nationCode: "PRT", name: "Tondela", populationBand: "small" },
    { nationCode: "PRT", name: "Vila das Aves", populationBand: "small" },
    { nationCode: "PRT", name: "Vila do Conde", populationBand: "small" },
    { nationCode: "PRT", name: "Vila Nova de Famalicão", populationBand: "small" },
  ],
  FRA: [
  ...
  BRA: [
    ...
    { nationCode: "BRA", name: "Belem", populationBand: "large" },
    { nationCode: "BRA", name: "Goiania", populationBand: "large" },
    { nationCode: "BRA", name: "Campinas", populationBand: "large" },
    { nationCode: "BRA", name: "Maceio", populationBand: "large" },
    { nationCode: "BRA", name: "Ribeirao Preto", populationBand: "large" },
    { nationCode: "BRA", name: "Sao Bernardo do Campo", populationBand: "large" },
    { nationCode: "BRA", name: "Curitiba", populationBand: "mid" },
    { nationCode: "BRA", name: "Manaus", populationBand: "mid" },
    { nationCode: "BRA", name: "Santos", populationBand: "mid" },
    { nationCode: "BRA", name: "Cuiaba", populationBand: "mid" },
    { nationCode: "BRA", name: "Florianopolis", populationBand: "mid" },
    { nationCode: "BRA", name: "Londrina", populationBand: "mid" },
    { nationCode: "BRA", name: "Caxias do Sul", populationBand: "mid" },
    { nationCode: "BRA", name: "Chapeco", populationBand: "small" },
    { nationCode: "BRA", name: "Braganca Paulista", populationBand: "small" },
    { nationCode: "BRA", name: "Mirassol", populationBand: "small" },
    { nationCode: "BRA", name: "Criciuma", populationBand: "small" },
    { nationCode: "BRA", name: "Sao Joao del-Rei", populationBand: "small" },
    { nationCode: "BRA", name: "Ponta Grossa", populationBand: "small" },
    { nationCode: "BRA", name: "Novo Horizonte", populationBand: "small" },
  ],
  AND: [
