...
**Agent Notes** ([notes/README.md](../../reference-project/.agents/notes/README.md)) are decision records with two axes encoded in their path — `{lifecycle}/{class}/yyyy-mm-dd-topic.md`:
...
**The `dsh-*` skills** are the operational layer on top: [dsh-archive-agent-notes](../../reference-project/.agents/skills/dsh-archive-agent-notes/SKILL.md) (archival judgment), [dsh-code-review](../../reference-project/.agents/skills/dsh-code-review/SKILL.md), [dsh-doc-standards](../../reference-project/.agents/skills/dsh-doc-standards/SKILL.md) and [dsh-prose-standard](../../reference-project/.agents/skills/dsh-prose-standard/SKILL.md) (placement vs. editorial judgment, split deliberately), [dsh-trim-cot-leakage](../../reference-project/.agents/skills/dsh-trim-cot-leakage/SKILL.md) (hunts prose that reads like a leaked reasoning transcript — dead citations like "(decision N)", "this cut", reviewer-addressed justifications), [dsh-doc-site-sync](../../reference-project/.agents/skills/dsh-doc-site-sync/SKILL.md) (VitePress projection), [dsh-merging-stacked-prs](../../reference-project/.agents/skills/dsh-merging-stacked-prs/SKILL.md) (GitHub's native stacked-PR feature), [dsh-pre-push-checks](../../reference-project/.agents/skills/dsh-pre-push-checks/SKILL.md), and [dsh-translate-docs](../../reference-project/.agents/skills/dsh-translate-docs/SKILL.md) (bilingual EN/ZH pairing).
