...
Club Transfers summarizes incoming, outgoing, loan, future, completed, failed, and pending transfer activity for a club while respecting negotiation privacy.

## 2. Primary user goals

- Filter by direction, type, status, and season
- Open player, club, or transfer details
- Navigate to Transfer Centre for authorized actions
- Review future commitments and installments
- Inspect completed transfer history
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > TRANSFERS                             Season 2004/05           |
|------------------------------------------------------------------------------|
| [All] [Incoming] [Outgoing] [Loans] [Future] [Pending]                        |
| Player            Direction   From/To          Fee       Date    Status        |
| Alex Forward      Incoming    Coastal FC       1.2m EC   1 Jan   Completed     |
|------------------------------------------------------------------------------|
| [Open Player] [Transfer Details] [Transfer Centre]                     [Back] |
+------------------------------------------------------------------------------+
```
...
interface ClubTransferRow {
  ...
  readonly counterpartyClubId?: string;
  readonly fee?: Money;
  readonly effectiveDate?: string;
  readonly status:
    "rumoured" | "offered" | "negotiating" | "agreed" | "completed" | "failed" | "cancelled";
  readonly visibility: TransferVisibilityPolicy;
}
```
...
- Rumour, offer, agreement, and completed transfer are distinct states
- Confidential terms obey viewer permissions
- Money uses explicit currency and visibility
- No transfer can be modified directly from a historical list row
...
1. Rumour, offer, agreement, and completed transfer are distinct states
2. Confidential terms obey viewer permissions
3. Money uses explicit currency and visibility
4. No transfer can be modified directly from a historical list row
...
```text
Implement Club Transfers for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club transfers screen
```
