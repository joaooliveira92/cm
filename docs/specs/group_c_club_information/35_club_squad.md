...
Club Squad is the working first-team roster used for selection, availability review, contract monitoring, sorting, filtering, comparison, and navigation into player records and tactical workflows.

## 2. Primary user goals

- Sort and filter players
- Select one or several rows
- Open player profile, contract, form, history, or training
- Move eligible players between first, reserve, and youth squads
- Launch comparison, squad registration, captaincy, or tactical selection
...
```text
+------------------------------------------------------------------------------+
| NORTH UNITED > FIRST TEAM                         27 players                  |
|------------------------------------------------------------------------------|
| [View: Selection v] [Position v] [Availability v] [Search]                   |
| Sel Pos Player              Age Cond Form Status Contract                     |
| GK      Alex Keeper          28  96%  7.1  Available  2007                    |
| DC      Morgan Centre        25  91%  6.8  Doubtful   2006                    |
|------------------------------------------------------------------------------|
| [Select XI] [Compare] [Actions] [Reserve Squad] [Youth Squad]          [Back]|
+------------------------------------------------------------------------------+
```
...
interface ClubSquadRow {
  ...
  readonly squadRegistrationId?: string;
  readonly positionSummary: string;
  readonly availability: PlayerAvailabilitySummary;
  readonly condition?: number;
  readonly moraleBand?: string;
  readonly formSummary?: PlayerFormSummary;
  readonly contractSummary: PlayerContractSummary;
  readonly selectionState: PlayerSelectionState;
...
- Displayed knowledge must respect scouting and managerial visibility
- Selection and squad membership are separate states
- Unavailable, injured, suspended, ineligible, and unregistered states must remain distinct
- Bulk actions must preview affected and skipped players
...
1. Displayed knowledge must respect scouting and managerial visibility
2. Selection and squad membership are separate states
3. Unavailable, injured, suspended, ineligible, and unregistered states must remain distinct
4. Bulk actions must preview affected and skipped players
...
```text
Implement Club Squad for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club squad screen
```
