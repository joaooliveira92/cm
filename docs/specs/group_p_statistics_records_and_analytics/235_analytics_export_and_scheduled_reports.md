# Screen 235: Analytics Export and Scheduled Reports
...
Analytics Export and Scheduled Reports manages privacy-safe exports, recurring report generation, delivery destinations, formats, retention, status, and failure recovery.

## 2. Primary user goals

- Export the current permitted report
- Create, edit, pause, or delete a schedule
- Choose supported format and authorized destination
...
- Exports are generated by a trusted service
- Schedules run against current permissions at execution time
- Secrets and private notes are excluded
- Duplicate schedule runs use idempotent execution keys
...
1. Exports are generated by a trusted service
2. Schedules run against current permissions at execution time
3. Secrets and private notes are excluded
4. Duplicate schedule runs use idempotent execution keys
...
```text
Implement Analytics Export and Scheduled Reports for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify analytics export and scheduled reports screen
```
