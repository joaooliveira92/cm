# Screen 224: Player Performance Dashboard
...
Player Performance Dashboard analyzes one or more players across minutes, positions, roles, contributions, ratings, physical output, availability, development, and comparable cohorts.

## 2. Primary user goals

- Choose players, period, competition, role, and cohort
- Inspect contributing matches and metric definitions
- Compare normalized and raw values
- Save a private player-analysis view
...
- Role and position comparisons use suitable denominators
- Hidden attributes and potential are never inferred
...
2. Small-sample warnings are explicit
3. Role and position comparisons use suitable denominators
4. Hidden attributes and potential are never inferred
...
```text
Implement Player Performance Dashboard for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player performance dashboard screen
```
