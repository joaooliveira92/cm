# Screen 234: Custom Report Builder
...
Custom Report Builder creates reusable reports from approved dimensions, measures, filters, groupings, sorting, visualizations, and delivery scopes without allowing arbitrary code execution.

## 2. Primary user goals

- Select an approved report data source
- Add dimensions, measures, filters, and sorting
- Preview accessible table and chart outputs
- Save, duplicate, share, or schedule the report
...
- No arbitrary SQL, script, expression, or executable markup is accepted
- Report fields obey permission and knowledge policy
- Premises use named parameters rather than hidden constants
- Invalid definitions cannot be saved or scheduled
...
1. No arbitrary SQL, script, expression, or executable markup is accepted
2. Report fields obey permission and knowledge policy
3. Premises use named parameters rather than hidden constants
4. Invalid definitions cannot be saved or scheduled
...
```text
Implement Custom Report Builder for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify custom report builder screen
```
