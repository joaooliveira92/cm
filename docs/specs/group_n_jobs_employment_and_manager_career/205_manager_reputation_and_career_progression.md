# Screen 205: Manager Reputation and Career Progression
...
Manager Reputation and Career Progression presents reputation scope, career standing, employer interest, achievements, performance evidence, milestones, and progression trends.

## 2. Primary user goals

- Review reputation by football scope and period
- Open achievements, honours, history, and interested employers where visible
- Compare current and prior career stages
- Review progression milestones and qualifications
...
```text
+------------------------------------------------------------------------------+
| Reputation bands, scope, achievements, interest, milestones, trends and evid |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerCareerProgressionModel {
...
- Reputation is a simulation measure rather than personal worth
- Employer interest may be uncertain
- Hidden exact formulas remain private
- Progression derives from committed career evidence
...
1. Reputation is a simulation measure rather than personal worth
2. Employer interest may be uncertain
3. Hidden exact formulas remain private
4. Progression derives from committed career evidence
...
```text
Implement Manager Reputation and Career Progression for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager reputation and career progression screen
```
