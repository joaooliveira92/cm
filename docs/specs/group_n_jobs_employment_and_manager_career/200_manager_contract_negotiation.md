# Screen 200: Manager Contract Negotiation
...
Manager Contract Negotiation manages proposal revisions between the manager and employer for wage, duration, clauses, start date, authority, staffing allowances, and supported expectations.

## 2. Primary user goals

- Review immutable proposal history
- Accept, reject, withdraw, or submit a permitted counterproposal
- Compare revisions and changed terms
- Review consequences for current employment
...
```text
+------------------------------------------------------------------------------+
| Offer history, current proposal, compensation, clauses, authority, deadline  |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerContractNegotiationModel {
...
- Only the current valid proposal may be accepted
- Every counterproposal creates an immutable revision
- Financial and authority terms use trusted schemas
- Negotiation outcomes do not alter employment before completion
...
1. Only the current valid proposal may be accepted
2. Every counterproposal creates an immutable revision
3. Financial and authority terms use trusted schemas
4. Negotiation outcomes do not alter employment before completion
...
```text
Implement Manager Contract Negotiation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager contract negotiation screen
```
