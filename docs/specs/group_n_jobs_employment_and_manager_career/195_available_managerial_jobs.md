# Screen 195: Available Managerial Jobs
...
Available Managerial Jobs lists public and manager-visible vacancies across clubs and national teams with reputation level, competition, status, expectations, contract outline, application deadline, and interest.

## 2. Primary user goals

- Filter by nation, competition, employer type, reputation, status, and deadline
- Open the vacancy, club, national team, competition, or application
- Save search criteria and career alerts
- Compare suitable vacancies
...
```text
+------------------------------------------------------------------------------+
| Vacancies, employers, competitions, expectations, deadlines, interest and ap |
|------------------------------------------------------------------------------|
...
- Result visibility follows public information and manager knowledge
- Suitability is advisory rather than guaranteed
- Application deadlines are authoritative
- Unknown contract terms remain unknown
...
1. Result visibility follows public information and manager knowledge
2. Suitability is advisory rather than guaranteed
3. Application deadlines are authoritative
4. Unknown contract terms remain unknown
...
```text
Implement Available Managerial Jobs for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify available managerial jobs screen
```
