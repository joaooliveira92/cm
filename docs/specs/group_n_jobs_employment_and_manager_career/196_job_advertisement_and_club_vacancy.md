# Screen 196: Job Advertisement and Club Vacancy
...
Job Advertisement and Club Vacancy presents one employer’s open role, circumstances, expectations, club state, desired profile, application process, deadline, and known compensation range.

## 2. Primary user goals

- Review the employer and role context
- Open club, squad, finances, objectives, and competition where visible
- Compare the manager profile with stated requirements
...
```text
+------------------------------------------------------------------------------+
| Employer, role, vacancy reason, expectations, desired profile, process, dead |
|------------------------------------------------------------------------------|
...
- The vacancy reason must not expose private personnel data
- Desired profile is a simulation preference, not an unlawful hiring rule
- Compensation may be a range or unavailable
- A vacancy does not imply manager eligibility
...
1. The vacancy reason must not expose private personnel data
2. Desired profile is a simulation preference, not an unlawful hiring rule
3. Compensation may be a range or unavailable
4. A vacancy does not imply manager eligibility
...
```text
Implement Job Advertisement and Club Vacancy for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify job advertisement and club vacancy screen
```
