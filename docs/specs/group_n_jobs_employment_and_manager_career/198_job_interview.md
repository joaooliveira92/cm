...
Job Interview runs a structured employer interview covering experience, objectives, recruitment, finances, club culture, staffing, tactical approach, availability, and contract expectations.

## 2. Primary user goals

- Review employer context and interview panel
- Answer supported professional questions
- Review measurable promises before committing
- Ask permitted questions about expectations and resources
- Complete the interview and await a decision
...
```text
+------------------------------------------------------------------------------+
| Employer panel, questions, evidence, response options, promises, deadline an |
|------------------------------------------------------------------------------|
...
- Interview content must remain professional and non-discriminatory
- Promises require measurable terms and dates
- Responses use current manager and employer evidence
- The interview cannot create an appointment directly
...
1. Interview content must remain professional and non-discriminatory
2. Promises require measurable terms and dates
3. Responses use current manager and employer evidence
4. The interview cannot create an appointment directly
...
```text
Implement Job Interview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify job interview screen
```
