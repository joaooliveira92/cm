# Screen 202: Resign from Current Position
...
Resign from Current Position lets an active manager leave a club or national-team role while remaining active and available for future employment.

## 2. Primary user goals

- Review contractual and career consequences
- Choose an immediate or permitted future-effective resignation
- Confirm organization continuity and next destination
- Cancel before the authoritative transaction begins
...
```text
+------------------------------------------------------------------------------+
| Current employer, contract, timing, compensation, organization continuity an |
|------------------------------------------------------------------------------|
...
```typescript
interface ManagerResignationPlan {
...
- The organization receives a valid interim or vacancy state
- History and manager identity remain active
- Current contract and authority revisions are revalidated
...
1. Resignation is not retirement
2. The organization receives a valid interim or vacancy state
3. History and manager identity remain active
4. Current contract and authority revisions are revalidated
...
```text
Implement Resign from Current Position for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify resign from current position screen
```
