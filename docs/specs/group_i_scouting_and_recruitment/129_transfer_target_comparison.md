# Screen 129: Transfer Target Comparison
...
Transfer Target Comparison compares shortlisted or searched players across position, role fit, visible attributes, form, statistics, value, wage, contract, availability, adaptation, risk, and scouting confidence.

## 2. Primary user goals

- Add, remove, or reorder candidates
- Choose comparison categories
- Open a candidate, report, agent, or transfer workflow
- Save a manager-private comparison
...
```text
+------------------------------------------------------------------------------+
| Candidate columns, metric rows, confidence, valuation ranges, risks, tactica |
|------------------------------------------------------------------------------|
...
```typescript
interface TransferTargetComparisonModel {
...
- Unknown values never rank as zero
- Money ranges require currency and confidence
- Recommendations must identify evidence and freshness
- Highlighting a best candidate must include uncertainty and textual explanation
...
1. Unknown values never rank as zero
2. Money ranges require currency and confidence
3. Recommendations must identify evidence and freshness
4. Highlighting a best candidate must include uncertainty and textual explanation
...
```text
Implement Transfer Target Comparison for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify transfer target comparison screen
```
