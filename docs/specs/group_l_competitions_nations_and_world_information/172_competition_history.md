# Screen 172: Competition History
...
Competition History presents past editions, champions, runners-up, promoted and relegated teams, hosts, formats, notable events, and historical participants.

## 2. Primary user goals

- Select an edition or era
- Open champion, runner-up, participant, or final
- Review format changes
- Export a safe history summary
...
```text
+------------------------------------------------------------------------------+
| Editions, champions, runners-up, hosts, formats, promotions and notable even |
|------------------------------------------------------------------------------|
...
```typescript
interface CompetitionHistoryModel {
...
- Unknown historical data remains unknown
- Renamed or extinct entities retain historical labels
- Different competition lineages require explicit relationships
...
2. Unknown historical data remains unknown
3. Renamed or extinct entities retain historical labels
4. Different competition lineages require explicit relationships
...
```text
Implement Competition History for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify competition history screen
```
