# Screen 212: Club Release and Player Withdrawal
...
Handles club release responses, injury withdrawals, manager-agreed rests, late replacements, travel conflicts, and federation decisions.

## 2. Primary user goals

- Review club and player availability responses
- Open medical, fixture, and release-rule context
- Accept a withdrawal or request supported clarification
- Select an eligible replacement
...
Global Application Shell
  -> National Team
  -> Club Release and Player Withdrawal
...
- Health information follows strict permissions
- Club release rules are authoritative within the simulation
- The workflow must not pressure an injured player to participate
- Replacement does not alter the withdrawn player’s club status
...
1. Health information follows strict permissions
2. Club release rules are authoritative within the simulation
3. The workflow must not pressure an injured player to participate
4. Replacement does not alter the withdrawn player’s club status
...
```text
Implement Club Release and Player Withdrawal for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify club release and player withdrawal screen
```
