# Screen 213: International Team Tactics
...
Configures the national team formation, roles, instructions, set pieces, and tactical variants while accounting for limited preparation time and changing player pools.

## 2. Primary user goals

- Edit formations and team instructions
- Assign roles and set-piece priorities
- Save or load national-team tactics
- Review familiarity and squad-fit warnings
...
- National-team tactics do not overwrite club tactics
- Familiarity reflects international preparation and usage
- Unknown player suitability remains uncertain
- All edits use the standard trusted tactical validation path
...
1. National-team tactics do not overwrite club tactics
2. Familiarity reflects international preparation and usage
3. Unknown player suitability remains uncertain
4. All edits use the standard trusted tactical validation path
...
```text
Implement International Team Tactics for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify international team tactics screen
```
