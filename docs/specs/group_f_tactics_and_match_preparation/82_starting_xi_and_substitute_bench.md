# Screen 82: Starting XI and Substitute Bench
...
Starting XI and Substitute Bench assigns eligible players to the tactic’s starting slots and competition-valid substitute places while exposing availability, positional fit, condition, and warnings.

## 2. Primary user goals

- Assign a player to a formation slot
- Move players among starters, substitutes, and unselected lists
- Review eligibility and positional-fit explanations
- Apply a deterministic previewable auto-selection policy
- Submit the match selection through authoritative validation
...
```text
+------------------------------------------------------------------------------+
| STARTING XI AND BENCH                       Example City, 15 February         |
|------------------------------------------------------------------------------|
| Formation slots               Available players                              |
| GK  Alex Keeper               Jordan Keeper, Sam Reserve                     |
| DR  Morgan Right              ...                                            |
|------------------------------------------------------------------------------|
| Starters 11/11 | Substitutes 7/7 | Ineligible 2 | Doubtful 1                 |
| [Auto Select] [Clear] [Eligibility] [Tactics] [Submit Selection]              |
+------------------------------------------------------------------------------+
```
...
interface MatchLineupDraft {
  ...
  readonly startingAssignments: readonly LineupAssignment[];
  readonly substitutePlayerIds: readonly string[];
  readonly unselectedPlayerIds: readonly string[];
  readonly constraints: MatchLineupConstraints;
...
- A player may occupy at most one match-squad place
- Formation suitability does not override legal eligibility
- Auto-selection never submits automatically
- Substitute count and goalkeeper requirements come from competition rules
...
1. A player may occupy at most one match-squad place
2. Formation suitability does not override legal eligibility
3. Auto-selection never submits automatically
4. Substitute count and goalkeeper requirements come from competition rules
...
```text
Implement Starting XI and Substitute Bench for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify starting xi and substitute bench screen
```
