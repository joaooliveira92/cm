# Screen 85: Player Position Assignment
...
Player Position Assignment binds selected players to formation slots, tactical positions, roles, and duties for the active tactic while explaining naturalness and role suitability.

## 2. Primary user goals

- Assign a player to a formation slot
- Choose a valid position, role, and duty
- Swap two assignments
- Clear an assignment
- Review suitability, familiarity, and instruction implications
...
| POSITION ASSIGNMENT                                                          |
|------------------------------------------------------------------------------|
| Slot DR | Player Morgan Right | Position familiarity: Natural                 |
| Role [Full Back v] | Duty [Support v]                                         |
| Suitability: Strong | Familiarity: High                                       |
|------------------------------------------------------------------------------|
| [Assign Player] [Change Role] [Swap Slots] [Clear Assignment] [Apply]         |
+------------------------------------------------------------------------------+
```
...
```typescript
interface PositionAssignmentDraft {
  readonly tacticId: string;
  readonly assignments: readonly TacticalPlayerAssignment[];
  readonly playerSuitabilities: readonly PlayerRoleSuitabilitySummary[];
  readonly roleConstraints: readonly TacticalRoleConstraint[];
...
- Position familiarity, role suitability, current fitness, and legal eligibility are separate
- Unknown suitability remains uncertain
- Changing role previews invalidated overrides
- Assignment does not register or transfer a player
...
1. Position familiarity, role suitability, current fitness, and legal eligibility are separate
2. Unknown suitability remains uncertain
3. Changing role previews invalidated overrides
4. Assignment does not register or transfer a player
...
```text
Implement Player Position Assignment for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player position assignment screen
```
