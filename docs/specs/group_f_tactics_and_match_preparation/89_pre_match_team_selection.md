# Screen 89: Pre-Match Team Selection
...
Pre-Match Team Selection is the final match-specific review of lineup, substitutes, tactic, eligibility, fitness, roles, set pieces, and competition submission requirements before kickoff.

## 2. Primary user goals

- Review and edit lineup, bench, tactic, and set pieces
- Open medical, discipline, registration, and opposition details
- Run a final validation
- Submit the team before the authoritative deadline
- Return to the fixture or match preview
...
```text
+------------------------------------------------------------------------------+
| PRE-MATCH TEAM SELECTION                  North United v Example City         |
|------------------------------------------------------------------------------|
| Kickoff 19:45 | Competition First Division | Submit by 18:45                  |
| Formation 4-4-2 | Starters 11/11 | Bench 7/7                                 |
| Warnings: Morgan Centre requires a fitness test                               |
| Registration: Valid | Shirt numbers: Valid | Set pieces: Complete             |
|------------------------------------------------------------------------------|
| [Squad] [Tactics] [Eligibility] [Opposition Report] [Submit Team]             |
+------------------------------------------------------------------------------+
```
...
```typescript
interface PreMatchSelectionModel {
  readonly fixtureId: string;
  readonly clubId: string;
  readonly deadline: string;
  readonly lineupDraft: MatchLineupDraft;
  readonly tacticSnapshot: MatchTacticSnapshot;
  readonly eligibilityReport: MatchEligibilityReport;
  readonly setPieceCoverage: SetPieceCoverageSummary;
  readonly shirtNumberStatus: string;
  readonly issues: readonly PreMatchIssue[];
...
- Submission captures one coherent lineup and tactic revision
- The deadline is authoritative and may close while the screen is open
- Doubtful players may require acknowledgment but legal ineligibility blocks submission
...
1. Submission captures one coherent lineup and tactic revision
2. The deadline is authoritative and may close while the screen is open
3. Doubtful players may require acknowledgment but legal ineligibility blocks submission
...
```text
Implement Pre-Match Team Selection for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify pre match team selection screen
```
