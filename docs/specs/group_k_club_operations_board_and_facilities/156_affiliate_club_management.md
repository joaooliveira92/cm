# Screen 156: Affiliate Club Management
...
Affiliate Club Management reviews current affiliations and creates, renews, changes, or ends supported relationships for loans, youth development, scouting, commercial reach, shared facilities, or work-permit pathways.

## 2. Primary user goals

- Review active affiliate terms and history
- Search or request a supported affiliate type
- Compare candidate clubs
- Renew, revise, or end an affiliation
- Submit one relationship transaction
...
```text
+------------------------------------------------------------------------------+
| Affiliates, relationship type, benefits, obligations, dates, candidates, sta |
|------------------------------------------------------------------------------|
...
```typescript
interface AffiliateManagementDraft {
...
- Affiliation does not merge club ownership or data permissions
- Benefits depend on policy and may be uncertain
- Loans and player movement still require eligibility
- Ending an affiliation preserves historical records
...
1. Affiliation does not merge club ownership or data permissions
2. Benefits depend on policy and may be uncertain
3. Loans and player movement still require eligibility
4. Ending an affiliation preserves historical records
...
```text
Implement Affiliate Club Management for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify affiliate club management screen
```
