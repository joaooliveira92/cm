# Screen 254: Participant and Manager Administration
...
Participant and Manager Administration manages the relationship between session participants, local profiles, controlled managers, temporary substitutes, spectators, and ownership transfers.

## 2. Primary user goals

- Assign or release permitted manager control
- Add a temporary substitute or spectator where supported
- Review online, away, disconnected, and abandoned states
- Transfer manager ownership through an explicit workflow
...
- One manager has at most one authoritative controller at a time
- Participant identity and manager identity remain distinct
- Temporary control has explicit start and expiry conditions
- Ownership changes preserve an audit trail
...
1. One manager has at most one authoritative controller at a time
2. Participant identity and manager identity remain distinct
3. Temporary control has explicit start and expiry conditions
4. Ownership changes preserve an audit trail
...
```text
Implement Participant and Manager Administration for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify participant and manager administration screen
```
