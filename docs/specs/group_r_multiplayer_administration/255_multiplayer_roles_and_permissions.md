# Screen 255: Multiplayer Roles and Permissions
...
Multiplayer Roles and Permissions configures host, co-host, participant, spectator, substitute, and administrator capabilities without granting forbidden career-domain authority.

## 2. Primary user goals

- Review role capabilities and current assignments
- Assign or revoke supported session roles
- Configure invitation, pause, save, moderation, and timing permissions
- Restore secure session defaults
...
- Session roles do not override club or national-team authority
- No participant may grant a capability they do not possess
- Critical changes require current host or server authority
- Permission changes are effective only after authoritative commit
...
1. Session roles do not override club or national-team authority
2. No participant may grant a capability they do not possess
3. Critical changes require current host or server authority
4. Permission changes are effective only after authoritative commit
...
```text
Implement Multiplayer Roles and Permissions for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify multiplayer roles and permissions screen
```
