# Screen 262: Participant Removal and Session Moderation
...
Participant Removal and Session Moderation handles voluntary departure, inactivity, removal, temporary restriction, spectator conversion, abandoned managers, and session continuity.

## 2. Primary user goals

- Leave the session safely
- Review permitted moderation actions and reasons
- Remove or restrict a participant when authorized
- Assign continuity for abandoned controlled managers
...
Global Application Shell
  -> Multiplayer
  -> Participant Removal and Session Moderation
...
- Moderation uses professional nonabusive reason codes
- Removal is not career punishment for in-game performance
- Session secrets are revoked promptly
- Manager continuity and participant removal commit coherently
...
1. Moderation uses professional nonabusive reason codes
2. Removal is not career punishment for in-game performance
3. Session secrets are revoked promptly
4. Manager continuity and participant removal commit coherently
...
```text
Implement Participant Removal and Session Moderation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify participant removal and session moderation screen
```
