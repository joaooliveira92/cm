# Screen 133: Incoming Transfer Offer
...
Incoming Transfer Offer presents another club’s proposal for a controlled player, including fee structure, clauses, deadlines, player and board context, competing offers, and supported response options.

## 2. Primary user goals

- Review guaranteed and conditional consideration
- Accept, reject, negotiate, delay, or compare supported offers
- Open the buying club, player, contract, and squad-planner context
- Preview financial and squad consequences before responding
...
```text
+------------------------------------------------------------------------------+
| Buying club, player, fee, installments, clauses, deadline, interest, context |
|------------------------------------------------------------------------------|
...
```typescript
interface IncomingTransferOfferModel {
...
- Acceptance does not complete the transfer until all required conditions succeed
- Conditional fees are separate from guaranteed value
- Competing offers remain private according to policy
- Deadline and withdrawal state are authoritative
...
1. Acceptance does not complete the transfer until all required conditions succeed
2. Conditional fees are separate from guaranteed value
3. Competing offers remain private according to policy
4. Deadline and withdrawal state are authoritative
...
```text
Implement Incoming Transfer Offer for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify incoming transfer offer screen
```
