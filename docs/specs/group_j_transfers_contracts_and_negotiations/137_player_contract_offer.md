# Screen 137: Player Contract Offer
...
Player Contract Offer creates employment terms for a player after transfer permission, free-agent approach, youth progression, or renewal context.

## 2. Primary user goals

- Choose role, duration, wage, bonuses, clauses, and permitted promises
- Review agent or representative requirements
- Preview wage-budget and squad-status impact
- Submit, revise, withdraw, or save the draft
...
```text
+------------------------------------------------------------------------------+
| Role, duration, wage, bonuses, clauses, signing fee, agent fee, promises, bu |
|------------------------------------------------------------------------------|
...
```typescript
interface PlayerContractOfferDraft {
...
- Contract values use explicit currency and pay period
- Promises require measurable terms and review dates
- Agent fees remain separate from player compensation
- Submitting terms does not guarantee player acceptance
...
1. Contract values use explicit currency and pay period
2. Promises require measurable terms and review dates
3. Agent fees remain separate from player compensation
4. Submitting terms does not guarantee player acceptance
...
```text
Implement Player Contract Offer for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify player contract offer screen
```
