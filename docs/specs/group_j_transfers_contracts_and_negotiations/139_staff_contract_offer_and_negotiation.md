# Screen 139: Staff Contract Offer and Negotiation
...
Staff Contract Offer and Negotiation handles hiring and renewal terms for coaches, scouts, medical staff, directors, managers, and support personnel.

## 2. Primary user goals

- Offer a supported role and contract
- Assign proposed responsibilities separately
- Review compensation owed to another employer
- Accept, counter, withdraw, or end talks
...
Global Application Shell
  ...
  -> Staff Contract Offer and Negotiation
...
```text
+------------------------------------------------------------------------------+
| Staff role, responsibilities, duration, wage, clauses, compensation, start d |
|------------------------------------------------------------------------------|
...
```typescript
interface StaffContractNegotiationModel {
...
- Employment role and delegated responsibility are separate
- Approaching employed staff may require club permission or compensation
- Staff capability visibility remains knowledge-limited
- Agreement does not create employment before completion
...
1. Employment role and delegated responsibility are separate
2. Approaching employed staff may require club permission or compensation
3. Staff capability visibility remains knowledge-limited
4. Agreement does not create employment before completion
...
```text
Implement Staff Contract Offer and Negotiation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify staff contract offer and negotiation screen
```
