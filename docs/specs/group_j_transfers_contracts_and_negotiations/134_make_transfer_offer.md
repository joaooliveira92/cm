# Screen 134: Make Transfer Offer
...
Make Transfer Offer creates a structured proposal to another club for a player using upfront fees, installments, conditional clauses, exchanges, response deadline, and negotiation instructions.

## 2. Primary user goals

- Enter a permitted fee structure
- Add, edit, reorder, or remove supported clauses
- Include an eligible exchange player where supported
- Review budget and rule validation
- Submit one idempotent offer
...
```text
+------------------------------------------------------------------------------+
| Target, selling club, upfront fee, installments, clauses, exchange, deadline |
|------------------------------------------------------------------------------|
...
- The renderer never calculates affordability authoritatively
- Exchange players require separate consent and eligibility checks
- Clauses use policy-defined schemas and bounds
- An offer is not a transfer agreement or contract offer
...
1. The renderer never calculates affordability authoritatively
2. Exchange players require separate consent and eligibility checks
3. Clauses use policy-defined schemas and bounds
4. An offer is not a transfer agreement or contract offer
...
```text
Implement Make Transfer Offer for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify make transfer offer screen
```
