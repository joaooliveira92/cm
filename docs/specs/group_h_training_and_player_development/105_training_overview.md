...
The Training Overview is the central dashboard for team training, player development, workload, recovery, coaching coverage, unit performance, schedule warnings, and links to detailed training workflows.

## 2. Primary user goals

- Review the current training week and workload
- Open calendar, units, individual plans, coaching assignments, recovery, and reports
- Resolve overwork, understaffing, injury-risk, or missing-plan warnings
- Switch between first-team, reserve, and youth training scopes
...
```text
+------------------------------------------------------------------------------+
| Team workload, schedule, unit status, coaching coverage, development alerts, |
|------------------------------------------------------------------------------|
...
```typescript
interface TrainingOverviewModel {
...
- Overview data must come from one coherent training revision
- Training effects are probabilistic and must not be presented as guaranteed
- Medical recommendations and coaching opinions remain distinct
- The screen does not directly alter plans without an explicit workflow
...
1. Overview data must come from one coherent training revision
2. Training effects are probabilistic and must not be presented as guaranteed
3. Medical recommendations and coaching opinions remain distinct
4. The screen does not directly alter plans without an explicit workflow
...
```text
Implement Training Overview for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify training overview screen
```
