# Screen 108: Individual Training Plan
...
Individual Training Plan configures one player’s intensity, rest, additional focus, position or role work, trait development, rehabilitation limits, and review date.

## 2. Primary user goals

- Set individual intensity or use team default
- Select an additional focus
- Open position and role training
- Open trait-development workflow
- Set a review date and submit the plan
...
```text
+------------------------------------------------------------------------------+
| Player plan, intensity, focus, role training, trait work, medical limits and |
|------------------------------------------------------------------------------|
...
```typescript
interface IndividualTrainingPlanDraft {
...
- Medical restrictions override incompatible workload choices
- The plan does not guarantee attribute growth or trait acquisition
- Team schedule and individual plan effects are combined authoritatively
- Youth and rehabilitation policies may restrict available choices
...
1. Medical restrictions override incompatible workload choices
2. The plan does not guarantee attribute growth or trait acquisition
3. Team schedule and individual plan effects are combined authoritatively
4. Youth and rehabilitation policies may restrict available choices
...
```text
Implement Individual Training Plan for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify individual training plan screen
```
