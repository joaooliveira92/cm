# Screen 110: Additional Focus and Trait Development
...
Additional Focus and Trait Development manages a player’s optional skill emphasis and supported behavioral trait coaching with coach suitability, expected time range, conflicts, and cancellation consequences.

## 2. Primary user goals

- Choose one permitted additional focus
- Select a supported new trait or trait-removal objective
- Assign an eligible coach
- Review conflicts with tactics or existing traits
- Start, pause, cancel, or complete the coaching workflow
...
```text
+------------------------------------------------------------------------------+
| Additional focus, trait target, assigned coach, progress, conflicts, expecte |
|------------------------------------------------------------------------------|
...
```typescript
interface TraitDevelopmentDraft {
...
- Trait work is uncertain and may fail
- Only policy-defined traits and transitions are allowed
- Conflicting trait projects cannot run simultaneously unless policy permits
- Trait descriptions must remain neutral and football-specific
...
1. Trait work is uncertain and may fail
2. Only policy-defined traits and transitions are allowed
3. Conflicting trait projects cannot run simultaneously unless policy permits
4. Trait descriptions must remain neutral and football-specific
...
```text
Implement Additional Focus and Trait Development for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify additional focus and trait development screen
```
