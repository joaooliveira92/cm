# Screen 116: Youth Intake and Academy Development
...
Youth Intake and Academy Development presents academy pipeline status, intake forecasts, trial periods, youth candidates, academy coaching, education or safeguarding constraints, and promotion decisions.

## 2. Primary user goals

- Review intake forecast and its confidence
- Inspect eligible youth candidates and reports
- Offer supported youth or development agreements
- Assign plans and pathways
- Promote, retain, release, or extend trials through dedicated workflows
...
```text
+------------------------------------------------------------------------------+
| Academy summary, intake forecast, candidates, trial status, coaches, facilit |
|------------------------------------------------------------------------------|
...
```typescript
interface YouthAcademyDevelopmentModel {
...
- Youth information requires age-appropriate safeguards
- Forecasts must not reveal generated identities before the permitted stage
- Employment and registration rules are jurisdiction and competition specific
- The workflow must not solicit or expose unnecessary personal data
...
1. Youth information requires age-appropriate safeguards
2. Forecasts must not reveal generated identities before the permitted stage
3. Employment and registration rules are jurisdiction and competition specific
4. The workflow must not solicit or expose unnecessary personal data
...
```text
Implement Youth Intake and Academy Development for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify youth intake and academy development screen
```
