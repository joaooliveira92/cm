# Screen 102: Post-Match Team Talk
...
The Post-Match Team Talk lets the manager deliver a team-level and optional individual response after the final result, using context, expectations, effort, and performance evidence.

## 2. Primary user goals

- Review result and expectation facts
- Choose a supported team message
- Address selected players individually
- Preview audience and unavailable recipients
- Submit one authoritative interaction transaction
...
```text
+------------------------------------------------------------------------------+
| Final result, expectation context, team mood, message options, individual fo |
|------------------------------------------------------------------------------|
...
- Message options remain neutral and nonabusive
- Likely reactions are uncertain
- Promises require explicit measurable terms
- The talk cannot change the committed match result
...
1. Message options remain neutral and nonabusive
2. Likely reactions are uncertain
3. Promises require explicit measurable terms
4. The talk cannot change the committed match result
...
```text
Implement Post-Match Team Talk for an original football-management simulation. Use one
...
```text
docs(game-ui): specify post match team talk screen
```
