...
The Match Report provides a durable narrative and structured record of a completed fixture, including lineups, formations, timeline, goals, cards, substitutions, notable chances, tactical summary, attendance, and officials.

## 2. Primary user goals

- Navigate report sections
- Open players, clubs, competition, officials, and incidents
- Review original and corrected versions if audited
- Export or print a safe report where supported
...
```text
+------------------------------------------------------------------------------+
| Match header, narrative, lineups, event timeline, tactical summary, attendan |
|------------------------------------------------------------------------------|
...
- Narrative must remain faithful to committed events
- Detailed content depends on competition simulation level
- Corrections preserve an audit trail
- Reports use original templates and licensed assets only
...
1. Narrative must remain faithful to committed events
2. Detailed content depends on competition simulation level
3. Corrections preserve an audit trail
4. Reports use original templates and licensed assets only
...
```text
Implement Match Report for an original football-management simulation. Use one
...
```text
docs(game-ui): specify match report screen
```
