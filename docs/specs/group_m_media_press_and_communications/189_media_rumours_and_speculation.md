# Screen 189: Media Rumours and Speculation
...
Media Rumours and Speculation lists reported claims about transfers, jobs, selection, injuries, tactics, contracts, ownership, and club projects with source, confidence, age, spread, and response status.

## 2. Primary user goals

- Filter rumours by topic, entity, confidence, and freshness
- Open the subject, source, related transaction, or narrative
- Respond, monitor, ignore, or delegate when authorized
- Compare the rumour with known public facts
...
```text
+------------------------------------------------------------------------------+
| Rumour subject, category, source, confidence, freshness, spread, linked fact |
|------------------------------------------------------------------------------|
...
- Rumours are explicitly nonauthoritative
- Confidence and source are visible
- Hidden true state must not leak through ordering or response availability
- Expired or disproven rumours remain distinguishable from deleted content
...
1. Rumours are explicitly nonauthoritative
2. Confidence and source are visible
3. Hidden true state must not leak through ordering or response availability
4. Expired or disproven rumours remain distinguishable from deleted content
...
```text
Implement Media Rumours and Speculation for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify media rumours and speculation screen
```
