...
The Media Centre is the manager’s consolidated dashboard for upcoming press obligations, published stories, active narratives, rumours, interview requests, public reactions, communication history, and delegated media responsibilities.

## 2. Primary user goals

- Review upcoming media obligations and deadlines
- Open press conferences, interviews, rumours, narratives, relationships, and history
- Accept, decline, delegate, or reschedule eligible requests
- Review recently published stories and public reaction
...
```text
+------------------------------------------------------------------------------+
| Obligations, stories, narratives, rumours, requests, reactions, delegation,  |
|------------------------------------------------------------------------------|
...
- Media obligations and optional interview requests remain distinct
- Private career information must not appear before its publication boundary
- Story summaries reference committed career facts or explicitly identified speculation
- Delegated media actions remain bound by staff authority
...
1. Media obligations and optional interview requests remain distinct
2. Private career information must not appear before its publication boundary
3. Story summaries reference committed career facts or explicitly identified speculation
4. Delegated media actions remain bound by staff authority
...
```text
Implement Media Centre for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify media centre screen
```
