# Screen 241: Goal and Moment Awards
...
Goal and Moment Awards presents nominated and winning match events, including goals, saves, assists, comebacks, and supported notable moments.

## 2. Primary user goals

- Browse nominated events and categories
- Open the match, player, team, and event context
- Review event descriptions and selection basis
- Navigate prior winners
...
- Only committed match events may be nominated
- Media playback appears only when genuinely available
- Event descriptions remain faithful to canonical facts
- Generated visuals do not claim to be source footage
...
1. Only committed match events may be nominated
2. Media playback appears only when genuinely available
3. Event descriptions remain faithful to canonical facts
4. Generated visuals do not claim to be source footage
...
```text
Implement Goal and Moment Awards for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify goal and moment awards screen
```
