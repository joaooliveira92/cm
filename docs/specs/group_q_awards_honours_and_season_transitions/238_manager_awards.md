...
Manager Awards presents monthly, seasonal, competition, national, and career awards for managers using committed sporting evidence and the relevant award policy.

## 2. Primary user goals

- Browse manager award categories and periods
- Open nominees, winner, employer, and supporting results
- Review disclosed criteria and history
- Open the manager career profile
...
- Awards do not define personal worth
- Dismissed or departed managers remain eligible only when rules permit
- Club and national-team evidence remains correctly scoped
- Selection does not expose hidden reputation formulas
...
1. Awards do not define personal worth
2. Dismissed or departed managers remain eligible only when rules permit
3. Club and national-team evidence remains correctly scoped
4. Selection does not expose hidden reputation formulas
...
```text
Implement Manager Awards for an original football-management simulation. Use stable
...
```text
docs(game-ui): specify manager awards screen
```
